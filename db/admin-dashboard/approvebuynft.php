...
<html lang="en">
  <head>
    ...
    <title>deluxenfts - Admin Dashboard</title>
  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
                ...
                <div :class="isShowPopper && 'show'" class="popper-root fixed" x-ref="popperRoot">
                  <div class="popper-box w-64 rounded-lg border border-slate-150 bg-white shadow-soft dark:border-navy-600 dark:bg-navy-700">
                    ...
                    <div class="flex flex-col pt-2 pb-5">
                      ...
                      <a href="mailto:support@deluxenfts.online" class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
      ...
      <li>
        ...
        <li>
          <a x-data="navLink" href="approvebuynft.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
                <i class="fa-solid fa-file-text-o"> </i>
              </span>
              Approve purchased nft
            </span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a x-data="navLink" href="approveuser.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
                <i class="fa-solid fa-file-text-o"> </i>
              </span>
   ...
   <div class="flex items-center space-x-4 py-5 lg:py-6">
          <h2 class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl">
           view all purchased nfts by clients
          </h2>
...
// Query to fetch all pending and approved NFTs from the 'buy' table
$sql = 'SELECT * FROM `buy` WHERE `status` IN ("Pending", "Approved") ORDER BY `id` DESC';
...
if ($row == NULL) {
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">NO NFT bought Yet!</h3>
                            </div>
                            <!-- /.card-header -->
    ...
    echo '<div class="card mt-3">
            <div class="overflow-x-auto">
                <table class="is-hoverable w-full text-left">
                    <thead>
                        <tr>
                            <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">No</th>
                            <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Account ID</th>
                            ...
                            <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">AUTHOR NAME</th>
                            <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">NFT AMOUNT</th>
    ...
    while ($detail = $run_sql->fetch_assoc()) {
        ...
        $photo = $detail['nft_picture'];
        $author_name = $detail['author_name'];
        $nft_amount = $detail['nft_amount'];
        ...
        echo '<tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
                ...
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">' . $account_id . '</td>
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                    <div class="avatar flex h-10 w-10">
                        <img class="mask is-squircle" src="' . $photo . '" alt="NFT Image">
                    </div>
                </td>
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">' . $author_name . '</td>
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">' . $nft_amount . '</td>
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">' . $status . '</td>
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                    <form action="../controller/delete.php" method="post">
                        <input type="hidden" name="id" value="' . $id . '">
                        <button type="submit" value="approve_buynft" name="submit" class="btn bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90">
                            Approve
                        </button>
                    </form>
                </td>
                <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                    <form action="../controller/delete.php" method="post">
                        <input type="hidden" name="id" value="' . $id . '">
                        <button type="submit" value="remove_buynft" name="submit" class="btn bg-secondary font-medium text-white hover:bg-secondary-focus focus:bg-secondary-focus active:bg-secondary-focus/90">
                            Delete
                        </button>
                    </form>
                </td>
