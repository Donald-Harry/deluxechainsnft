...
<html lang="en">
  <head>
    ...
    <title>Deluxeartnft - Admin Dashboard</title>
  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
      ...
      <div class="sidebar print:hidden">
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
             ...
             <div x-data="usePopper({placement:'right-end',offset:12})" @click.outside="isShowPopper && (isShowPopper = false)" class="flex">
                <button @click="isShowPopper = !isShowPopper" x-ref="popperRef" class="avatar h-12 w-12">
                  <img class="rounded-full" src="../dashboard/user.jpg" alt="avatar">
                      ...
                      <a href="profile.php" class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                        ...
                        <div>
                          ...
                          <div class="text-xs text-slate-400 line-clamp-1 dark:text-navy-300">
                            <?=$_SESSION['name']?>, Account Update
                          </div>
                        </div>
                      </a>
                      <a href="mailto:support@deluxeartnft.com" class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
        ...
        <div class="sidebar-panel">
          <div class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
            ...
            <!-- Sidebar Panel Body -->
              ...
              <p style="margin-left: 20px;">Username: <?=$_SESSION['name']?></p>
        ...
        <li>
          <a x-data="navLink" href="top_up_history.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
      ...
      <div class="my-3 mx-4 h-px bg-slate-200 dark:bg-navy-500"></div>
               <ul class="flex flex-1 flex-col px-4 font-inter">
        <li>
          <a x-data="navLink" href="approvenft.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
        ...
        <li>
          <a x-data="navLink" href="wallet.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
        ...
        <li>
          <a x-data="navLink" href="reset.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
              ...
              <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                ...
                <div class="mt-3 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <img class="rounded-full ring ring-white dark:ring-navy-700" src="../dashboard/user.jpg" alt="avatar">
                    </div>
                  </div>
                  <button class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45" fill="none" viewbox="0 0 24 24" stroke="currentColor">
...
<?php
                       ...
                       <div class="col-12">
                         <div class="card">
                           <div class="card-header">
                             <h3 class="card-title">NO NFT CREATED Yet!</h3>
                           </div>
                           <!-- /.card-header -->
                           <div class="card-body table-responsive p-0" style="height: 410px;">';

                 }else {
                                             if (isset($_SESSION['nft'])) {
                                                    echo "<br><br>";
                                                    echo $_SESSION['nft'];
                                                    unset($_SESSION['nft']);
                                                }
    ...
    <div class="overflow-x-auto">
        <table class="is-hoverable w-full text-left">
           <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5"ead>
                <tr>
                   <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" >
                        No
                    </th>
                                    
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">NFT ART</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">USERNAME</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">EMAIL</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">COLLECTION_ID</th> 
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">NFT PRICE</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">DESCRIPTION</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">CREATION DATE</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">COLLECTION NAME</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">PRODUCT NAME</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">CATEGORY</th>
                                                ...
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Approve</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Delete</th> 
                </tr>
            </thead>
                    ...
                    <tbody>';
                        ...
                        <div class="avatar flex h-10 w-10">
                                          <img class="mask is-squircle" src="../xpanel/uploads/nfts' .$photo. '" alt="avatar">
                                       </div>

                        </td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$username.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$email.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$collection_id.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">$ '.$price.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5"><span class="tag tag-success">'.$description.'</span></td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5"> '.$date.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$collection_name.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$product_name.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$category.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$status.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                                            <form action="../controller/delete.php" method="post">
                                                              <input type="hidden" name="collection_id" value='.$collection_id.'>
                                                           
                                                              <button type="submit" value="approvenft" name="submit"
  ...
  >
    Approve
                                                            ...
                                                            <form action="../controller/delete.php" method="post">
                                                              ...
                                                              <button type="submit" value="remove_nft" name="submit"
