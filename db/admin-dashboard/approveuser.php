...
<?php
              include '../controller/connection.php';
               ...
               $sql = 'SELECT * FROM `verify` ORDER BY `id` DESC';
                       ...
                       <div class="col-12">
                         <div class="card">
                           <div class="card-header">
                             <h3 class="card-title">NO VERIFICATION PENDING Yet!</h3>
                           </div>
                           <!-- /.card-header -->
                ...
                <tr>
                   <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" >
                        No
                                                ...
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">PHOTO</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">NATIONAL ID</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">DRIVERS LICENCE</th> 
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">SECURITY QUESTION</th>
                    ...
                    <tbody>';
                        ...
                        <div style="width: 300px;">
                                          <img class="mask is-squircle" src="../uploads/' .$photo. '" alt="avatar">
                                       </div>

                        </td>
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div style="width: 300px;">
                                          <img class="mask is-squircle" src="../uploads/' .$card. '" alt="avatar">
                                       </div>
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        <div style="width: 300px;">
                                          <img class="mask is-squircle" src="../uploads/' .$license. '" alt="avatar">
                                       </div>

                        </td>
                        
                       
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$question.'</td>
                                                            ...
                                                            <form action="../controller/delete.php" method="post">
                                                              ...
                                                              <button type="submit" value="approveverify" name="submit"
