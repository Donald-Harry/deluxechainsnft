...
<script src="https://cdn.jsdelivr.net/npm/alpine-popper@2.x"></script>
  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <!-- Page Wrapper -->
    <div id="root" class="min-h-50vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
      <!-- Sidebar -->
   ...
   <div class="flex items-center space-x-4 py-5 lg:py-6">
          <h2 class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl">
            Scroll Table to View Client Details
          </h2>
  ...
  >
    ...
    <span><a href="home.php">Refresh</a></span>
  </button>
   ...
   <div style="padding: 1rem 0;">
    ...
    if ($row < 1) {
        echo '<div style="background: white; border-radius: 0.25rem; box-shadow: 0 0.125rem 0.25rem rgba(0,0,0,0.075);">
                <div style="padding: 1rem; border-bottom: 1px solid rgba(0,0,0,0.125);">
                    <h5 style="font-size: 1.25rem; margin: 0;">No Registered Client Yet</h5>
                </div>
                <div style="height: 410px;"></div>
              </div>';
    } else {
        echo '<div style="background: white; border-radius: 0.25rem; box-shadow: 0 0.125rem 0.25rem rgba(0,0,0,0.075); margin-top: 1rem;">
                <div style="padding: 1rem; border-bottom: 1px solid rgba(0,0,0,0.125);">
                    <h5 style="font-size: 1.25rem; margin: 0;">Registered Members</h5>
                </div>
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead style="background-color: #f8f9fa;">
                            <tr>
                                ...
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Date/Time</th>
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Name</th>
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Password</th>
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Country</th>
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Account ID</th>
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Email</th>
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Phone</th>
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Wallet</th>
                                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">Actions</th>
                            </tr>
                        </thead>
                        <tbody>';
        ...
        while ($detail = $run_sql->fetch_assoc()) {
            ...
            $rowColor = $count % 2 === 0 ? 'background-color: #f8f9fa;' : 'background-color: white;';

            echo '<tr style="'.$rowColor.'">
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$count++.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$date.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$fname.' '.$lname.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$password.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$country.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$account_id.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$email.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$cnumber.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">'.$phone.'</td>
                    <td style="padding: 0.75rem; text-align: left; border-bottom: 1px solid #dee2e6;">
                        <form action="../controller/delete.php" method="post" style="display: inline;">
                            <input type="hidden" name="id" value="'.$id.'">
                            <button type="submit" value="remove_member" name="submit" style="padding: 0.25rem 0.5rem; background-color: #dc3545; color: white; border: none; border-radius: 0.25rem; cursor: pointer; font-size: 0.875rem;">
                                Delete
                            </button>
                        </form>
                    </td>
