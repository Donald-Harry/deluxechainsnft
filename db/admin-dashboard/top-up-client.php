  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
   ...
   <div class="flex items-center space-x-4 py-5 lg:py-6">
          <h2 class="text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl">
           Fill the form below to credit a client
          </h2>
          ...
          <ul class="hidden flex-wrap items-center space-x-2 sm:flex">
            ...
            <li>COPY ACCOUNT ID AND EMAIL</li>
          </ul>
        </div>
            ...
            <div class="card p-4 sm:p-5">
              ...
              <div class="mt-4 space-y-4">
                ...
                <label class="block">
                  <span>Client ID</span>
                  <span class="relative mt-1.5 flex">
                    <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" type="text" name="client_id" placeholder="Enter client ID" id="client_id" required>
                    <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                ...
                <label class="block">
                  ...
                  <span class="relative mt-1.5 flex">
                    <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent "type="number" name="client_balance" placeholder="$ 0.00" required>
                    <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                ...
                <label class="block">
                  ...
                  <span class="relative mt-1.5 flex">
                    <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent "type="number" name="client_profit" class="form-control" id="exampleInputEmail1" placeholder="$ 0.00" required>
                    <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                      <i class="fa-solid fa-map-pin text-base"></i>
                    </span>
                  </span>
                 ...
                 <label class="block">
                  <span>Client INCOME in ETH</span>
                  <span class="relative mt-1.5 flex">
                    <input class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent "type="number" name="client_bonus" class="form-control" id="exampleInputEmail1" placeholder="4 ETH" required>
                    <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                      <i class="fa-solid fa-map-pin text-base"></i>
                    </span>
                  </span>
                 ...
                 <label class="block">
                  ...
                  <span class="relative mt-1.5 flex">
                      ...
                      <select name="status" class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent " id="exampleInputPassword1">
            ...
            <div class="sticky top-24 mt-3">
              <ol class="steps is-vertical line-space">
                ...
                <li class="step pb-8 before:bg-slate-200 dark:before:bg-navy-500">
                  ...
                  <h3 class="ml-4 text-slate-700 dark:text-navy-100">
                    Enter the client Income and Expenses
                  </h3>
                </li>
                <li class="step pb-8 before:bg-slate-200 dark:before:bg-navy-500">
