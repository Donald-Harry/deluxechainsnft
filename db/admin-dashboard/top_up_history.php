...
<?php
    ...
    <div class="overflow-x-auto">
        <table class="is-hoverable w-full text-left">
           <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5"ead>
                <tr>
                   <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">
                        No
                    </th>
                   
                                     <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Transaction ID</th>
                                     ...
                                     <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Client Name</th>
                                     <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Client Email</th>
                                     <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" style="color: #00ff00">Income</th>
                                     <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" style="color: #ffd600">Expenses</th>
                    ...
                    <tbody>';
                     ...
                     $count = 1;
                                  while ($detail = $run_sql->fetch_assoc()) {
                                          ...
                                          $fetch_name = 'SELECT `fname`, `email` FROM `members` WHERE `account_id` = "'.$client_id.'"';
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                           '.$count++.'
                                                  ...
                                                  <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$name.'</td>
                                                  <td class="whitespace-nowrap px-4 py-3 sm:px-5"><span class="tag tag-success">'.$email.'</span></td>
                                                  <td class="whitespace-nowrap px-4 py-3 sm:px-5" style="color: #00ff00">$ '.$balance.'.00</td>
                                                  <td class="whitespace-nowrap px-4 py-3 sm:px-5" style="color: #ffd600">$ '.$profit.'.00</td>
                         ...
                         <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                                   <form action="../controller/delete.php" method="post">
                                        <input type="hidden" name="id" value='.$id.'>
                                         ...
                                         <button type="submit" value="remove" name="submit"
