                ...
                <tr>
                   <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5" >
                        No
                                                ...
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Name</th>
                                                ...
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Wallet_address</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">type</th> 
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Amount</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">Date/Time</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">transact_id</th>
                                                <th class="whitespace-nowrap rounded-tl-lg bg-slate-200 px-4 py-3 font-semibold uppercase text-slate-800 dark:bg-navy-800 dark:text-navy-100 lg:px-5">commission</th>
                    ...
                    <tbody>';
                        ...
                        <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$fname.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$email.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$wallet_address.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$type.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">$ '.$amount.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5"><span class="tag tag-success">'.$date.'</span></td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5"> '.$transact_id.'</td>
                                                            <td class="whitespace-nowrap px-4 py-3 sm:px-5">'.$commission.'</td>
  ...
  >
    Approve
                                                            ...
                                                            <form action="../controller/delete.php" method="post">
                                                              ...
                                                              <button type="submit" value="remove_history" name="submit"
