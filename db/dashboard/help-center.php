...
<div class="mt-10 grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
                            ...
                            <ul class="space-y-3.5 font-inter font-medium">
                                <li>
                                    <a class="group inline-flex items-center space-x-2 tracking-wide outline-none transition-colors hover:text-slate-800 focus:text-navy-800 dark:hover:text-navy-100 dark:focus:text-navy-100" href="#">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-slate-400 transition-colors group-hover:text-slate-500 group-focus:text-slate-500 dark:text-navy-300 dark:group-hover:text-navy-200 dark:group-focus:text-navy-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div x-data="{expandedItem:'item-1'}" class="space-y-4 sm:space-y-5">
                            <div class="card" x-data="accordionItem('item-1')">
                                <div class="flex cursor-pointer items-center justify-between p-4" @click="expanded = !expanded">
                                    <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                                        What currencies can I use on Deluxeartnft?
                                    </h3>
                                ...
                                <div x-collapse="" x-show="expanded">
                                    <div class="px-4 pb-4">
                                        <p>
                                            The core cryptocurrencies you can use on Deluxeartnft are Ethereum
                                            (ETH/WETH) We support a few other payment tokens,
                                            but it's not currently possible to use non-crypto currencies like USD or the Euro.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="card" x-data="accordionItem('item-2')">
                                ...
                                <div x-collapse="" x-show="expanded" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                    <div class="px-4 pb-4">
                                        <p>
                                            If you want to get more selective, you can narrow your search in a
                                            variety of ways with the Sort by dropdown menu. This gives you many
                                            options to arrange your search, for example, items that were Recently sold, created, or listed.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div class="card" x-data="accordionItem('item-3')">
                                ...
                                <div x-collapse="" x-show="expanded" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                    <div class="px-4 pb-4">
                                        <p>
                                            Sometimes your wallet extension and computer browser might get a little out of sync. We all need a reset sometimes!
                                            Usually, wallet connection issues can be resolved by following these troubleshooting steps:
                                        </p>
                                        <div class="flex space-x-2 pt-3">
                                            <ul>
                                                <li>Make sure your wallet extension is fully updated. To confirm you're using the latest version, you can remove and re-add the extension (be sure to save your recovery phrase first!) </li>
                                                <li>Clear your cache and restart your browser. Make sure you're running the latest version of your browser.</li>
                                                <li>Set your wallet to Ethereum mainnet, with no ad blockers running.</li>
                                                <li>Turn off all other browser extensions except for your wallet.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card" x-data="accordionItem('item-4')">
                                <div class="flex cursor-pointer items-center justify-between p-4" @click="expanded = !expanded">
                                    <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                                        Which blockchains are compatible with Deluxeartnft?
                                    </h3>
                                    <div :class="expanded &amp;&amp; '-rotate-180'" class="text-sm font-normal leading-none text-slate-400 transition-transform duration-300 dark:text-navy-300">
                                        <i class="fas fa-chevron-down"></i>
                                    </div>
                                ...
                                <div x-collapse="" x-show="expanded" style="display: none; height: 0px; overflow: hidden;" hidden="">
                                    <div class="px-4 pb-4">
                                        <p>
                                            It’s always been our goal to connect people with NFTs across every chain possible.
                                            Deluxeartnft now offers cross-blockchain compatibility
                                            across the Ethereum, Polygon, Klaytn, Solana, Arbitrum, Optimism, Avalanche, and BNB blockchains.
                                        </p>
                                    </div>
                                </div>
                            </div>
