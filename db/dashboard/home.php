...
<body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
      ...
      <div class="main-sidebar">
        <div
          ...
          <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
            ...
            <!-- Apps -->
            <a style="display: none;" href="apps-list.html"
            ...
            <!-- Pages And Layouts -->
            <a style="display: none;" href="pages-card-user-1.html"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
            ...
            <!-- Forms -->
            <a style="display: none;" href="form-input-text.html"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
            ...
            <!-- Components -->
            <a style="display: none;" href="components-accordion.html"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
            ...
            <!-- Elements -->
            <a style="display: none;" href="elements-avatar.html"
              class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              ...
              <div :class="isShowPopper && 'show'" class="popper-root fixed" x-ref="popperRoot">
                <div
                  ...
                  <div class="flex flex-col pt-2 pb-5">
                    ...
                    <a href="mailto:info@deluxenfts.online"
                      class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
        ...
        <div class="flex h-full grow flex-col bg-white pl-[var(--main-sidebar-width)] dark:bg-navy-750">
          ...
          <div x-data="{expandedItem:null}" class="h-[calc(100%-4.5rem)] overflow-x-hidden pb-6"
            ...
            <ul class="flex flex-1 flex-col px-4 font-inter">
              <li>
                <a x-data="navLink" href="home.php"
              ...
              <li>
                <a x-data="navLink" href="marketplace.php"
                  :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
              ...
              <li>
                <a x-data="navLink" href="my-collections.php"
                  :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                  class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                  <span>
                    <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
              ...
              <li>
                <a x-data="navLink" href="create-token.php"
                  :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                  class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                  <span>
                    <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
          ...
          <a x-data="navLink" href="../bitcoin-services" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out">
            <span>
              ...
              <li>
                <a x-data="navLink" href="openseapro.php"
                  :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'"
                  class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
                  <span>
                    <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
              ...
              <div class="grid grid-cols-2 gap-3 px-3">
                <div class="rounded-lg bg-slate-150 px-2.5 py-2 dark:bg-navy-600">
                  <div class="flex items-center justify-between space-x-1">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-secondary dark:text-secondary-light"
                ...
                <div class="rounded-lg bg-slate-150 px-2.5 py-2 dark:bg-navy-600">
                  <div class="flex items-center justify-between space-x-1">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 text-success" viewbox="0 0 20 20"
                      fill="currentColor">
                      <path fill-rule="evenodd"
            ...
            <div class="mt-4">
              ...
              <div class="mt-3 space-y-3 px-2">
                <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                  ...
                  <img src="../images/object/object-18.jpg" class="h-20 w-20 rounded-lg object-cover object-center"
                    alt="image">
                </div>
                ...
                <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                  ...
                  <img src="../images/object/object-2.jpg" class="h-20 w-20 rounded-lg object-cover object-center"
                    alt="image">
                </div>
                ...
                <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                  ...
                  <img src="../images/object/object-1.jpg" class="h-20 w-20 rounded-lg object-cover object-center"
                    alt="image">
                </div>
              </div>
            </div>
          ...
          <div x-show="activeTab === 'tabProjects'" x-transition:enter="transition-all duration-500 easy-in-out"
              ...
              <div class="rounded-lg bg-slate-100 p-3 dark:bg-navy-600">
                <div class="flex justify-between space-x-1">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" stroke-width="1.5"
                    class="h-5 w-5 text-primary dark:text-accent" fill="none" viewbox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
              <div class="flex items-center space-x-3">
                <img class="h-10 w-10 rounded-lg object-cover object-center" src="../images/illustrations/lms-ui.svg"
                  alt="image">
                <div>
            ...
            <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
              <div class="flex items-center space-x-3">
                <img class="h-10 w-10 rounded-lg object-cover object-center" src="../images/illustrations/store-ui.svg"
                  alt="image">
                <div>
                  <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                    Store Dashboard
            ...
            <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
              <div class="flex items-center space-x-3">
                <img class="h-10 w-10 rounded-lg object-cover object-center" src="../images/illustrations/chat-ui.svg"
                  alt="image">
                <div>
                  <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                    Chat Mobile App
            ...
            <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
              <div class="flex items-center space-x-3">
                <img class="h-10 w-10 rounded-lg object-cover object-center" src="../images/illustrations/nft.svg"
                  alt="image">
                <div>
                  <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                    NFT Marketplace App
                ...
                <div class="flex -space-x-3">
                  ...
                  <div class="avatar h-7 w-7 hover:z-10">
                    <img class="rounded-full ring ring-white dark:ring-navy-700"
                      src="<?= replace_image_ifNotEixt('../uploads/' . $feeder) ?>" alt="avatar">
                  </div>
                </div>
                <button
                  class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
          ...
          <div class="pointer-events-none absolute bottom-4 flex w-full justify-center">
            <div
              ...
              <button @click="activeTab = 'tabHome'" :class="activeTab === 'tabHome' && 'text-primary dark:text-accent'"
                ...
                <svg x-show="activeTab === 'tabHome'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0"
                  viewbox="0 0 20 20" fill="currentColor">
                  <path
              ...
              <button @click="activeTab = 'tabActivity'"
                ...
                class="btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25">
                <svg x-show="activeTab ===  'tabActivity'" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0"
                  viewbox="0 0 20 20" fill="currentColor">
                  <path fill-rule="evenodd"
                    d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z"
                    clip-rule="evenodd"></path>
          ...
          <div class="card bg-gradient-to-br from-purple-500 to-indigo-600 px-4 pb-4 sm:px-5">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
              <div>
                ...
                <p class="mt-3 text-xs+ text-indigo-100"> <i class="fa-brands fa-ethereum text-sm+"></i>
                  <?php echo $_SESSION['bonus']; ?> ETH</p>
              </div>
              ...
              <div class="grid grid-cols-2 gap-4 sm:gap-5 lg:gap-6">
                ...
                ';
                                    ...
                                    <button onclick="myFunction()"
                                      x-tooltip.placement.right="'Click to Copy Wallet Address'"
                                      class="btn h-5 w-5 shrink-0 rounded-full p-0 text-white hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                                  ...
                                  <p class="mt-3 text-xs+ text-indigo-100"> <i
                                      class="fa-brands fa-ethereum text-sm+"></i> <?php echo $_SESSION['bonus']; ?> ETH
                                  </p>
                                </div>
                              ...
                              <div x-data="{config:{numeral: true,numeralThousandsGroupStyle: 'thousand'}}">
                                ...
                                <form action="../controller/deposits.php" method="post">
                                  ...
                                  <div class="mt-1.5 flex h-9 -space-x-px">
                                    <input type="hidden" name="fname" class="form-control" id="inputPassword3"
                                      value="<?php echo $_SESSION['firstname'] ?>">
                                    <input type="hidden" name="email" class="form-control" id="inputPassword3"
                                      value="<?php echo $_SESSION['email'] ?>">
                                    <input type="hidden" name="account_id" class="form-control" id="inputPassword3"
                                    ...
                                    <select
                                      ...
                                      <option name="currency" required="" class="hover:bg-primary/20"
                                        x-tooltip.placement.right="'Dollar'">Dollar ($)</option>
                                    </select>
                                    <input x-input-mask="config" name="amount" onblur="amountInput()"
                                  ...
                                  <button type="submit"
                                    onclick="return alert('Kindly copy the wallet address and complete your deposit. Your account will be credited shortly after confirmation');"
                          ...
                          <label class="block">
                            <form action="../controller/process_withdrawal.php" method="post">
                              ...
                              <input name="wallet_address"
                                ...
                                placeholder="Paste ETH Wallet Address Here" type="text" tabindex="-1">
                              <div
                                class="ts-wrapper mt-1.5 w-full multi plugin-caret_position plugin-input_autogrow required invalid has-options">
                          </label>
                          <div x-data="{config:{numeral: true,numeralThousandsGroupStyle: 'thousand'}}">
                            ...
                            <div class="mt-1.5 flex h-9 -space-x-px">
                              <select
                                class="form-select rounded-l-lg border border-slate-300 bg-white px-3 py-2 pr-9 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                                <option name="currency" class="hover:bg-primary/20"
                                  x-tooltip.placement.right="'Dollar'">Dollar ($)</option>
                              </select>
                              <input name="amount" onblur="amountInput()"
                                class="form-input w-full rounded-r-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
 ...
 -->
        ...
        <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
          <div class="card p-2 pb-3">
            <div class="relative w-full">
              <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art5.jpg"
                alt="image">
            ...
            <div class="mx-2 mt-3">
              ...
              <form action="../controller/buynow_process.php" method="post">
                ...
                <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                <button style="width: 100%; margin: 10px;" type="submit"
                  class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
          ...
          <div class="card p-2 pb-3">
            <div class="relative w-full">
              <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art2.avif"
                alt="image">
              <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                <div>
                  <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
          ...
          <div class="card p-2 pb-3">
            <div class="relative w-full">
              <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art3.avif"
                alt="image">
              <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                <div>
                  <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
          ...
          <div class="card p-2 pb-3">
            <div class="relative w-full">
              <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art6.webp"
                alt="image">
              <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                <div>
                  <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
          ...
          <div class="card p-2 pb-3">
            <div class="relative w-full">
              <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art7.jfif"
                alt="image">
              <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                <div>
                  <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
          ...
          <div class="card p-2 pb-3">
            <div class="relative w-full">
              <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art4.jfif"
                alt="image">
              <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                <div>
                  <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
      ...
      <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
        <div class="card p-2 pb-3">
          <div class="relative w-full">
            <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art8.avif"
              alt="image">
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
              <div>
                <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
        ...
        <div class="card p-2 pb-3">
          <div class="relative w-full">
            <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art9.avif"
              alt="image">
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
              <div>
                <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
        ...
        <div class="card p-2 pb-3">
          <div class="relative w-full">
            <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art10.jpeg"
              alt="image">
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
              <div>
                <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
        ...
        <div class="card p-2 pb-3">
          <div class="relative w-full">
            <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art11.png"
              alt="image">
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
              <div>
                <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
        ...
        <div class="card p-2 pb-3">
          <div class="relative w-full">
            <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art12.jpg"
              alt="image">
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
              <div>
                <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
        ...
        <div class="card p-2 pb-3">
          <div class="relative w-full">
            <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art13.jpg"
              alt="image">
            <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
              <div>
                <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
        ...
        <div class="relative">
          <div class="pt-4">
            ...
            <div class="mt-1 flex justify-between space-x-2 rounded-2xl bg-slate-150 p-1.5 dark:bg-navy-800">
              ...
              <input class="form-input w-full bg-transparent px-2 text-right placeholder:text-slate-400/70"
