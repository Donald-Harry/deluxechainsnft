...
<!--_smartsupp.key = 'f1823c4a8c90acdb9fa3e58703ae570794a11c9c';-->
...
<div x-data="{showModal:false}">
    ...
    <!-- Input fields and select option -->
    ...
    <!-- Button with alert script -->
    <button type="submit" onclick="return alert('Kindly copy the wallet address and complete your deposit. Your account will be credited shortly after confirmation');" class="btn mt-5 h-10 w-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
 ...
 -->                  </div>
            ...
            <div class="col-span-12 lg:col-span-8 xl:col-span-9">
                <div class="flex items-center justify-between py-5">
                  ...
                  <a href="marketplace.php" class="border-b border-dotted border-current pb-0.5 font-medium text-primary outline-none transition-colors duration-300 hover:text-primary/70 focus:text-primary/70 dark:text-accent-light dark:hover:text-accent-light/70 dark:focus:text-accent-light/70">View All</a>
                </div>
                <div class="is-scrollbar-hidden overflow-x-auto">
                 ...
                 <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                      ...
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art5.jpg" alt="image">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                  ...
                                  <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="20">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art5.jpg">
                                    <input type="hidden" name="author_name" value="Awanzada">
                                    ...
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art2.avif" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="15">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art2.avif">
                                    <input type="hidden" name="author_name" value="emir_coby">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art3.avif" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="10">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art3.avif">
                                    <input type="hidden" name="author_name" value="Awanzada">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art6.webp" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="5">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art6.webp">
                                    <input type="hidden" name="author_name" value="LiaF">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art7.jfif" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="1.00">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art7.jfif">
                                    <input type="hidden" name="author_name" value="AZUKI #7079">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art4.jfif" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.9">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art4.jfif">
                                    <input type="hidden" name="author_name" value="Matic">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art8.avif" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                            </div>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.6">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art8.avif">
                                    <input type="hidden" name="author_name" value="Awanzada">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art9.avif" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.2">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art9.avif">
                                    <input type="hidden" name="author_name" value="emir_coby">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art10.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.1">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art10.jpeg">
                                    <input type="hidden" name="author_name" value="Awanzada">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art11.png" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.04">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art11.png">
                                    <input type="hidden" name="author_name" value="LiaF">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art12.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.03">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art12.jpg">
                                    <input type="hidden" name="author_name" value="Souvenir">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art13.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.02">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art13.jpg">
                                    <input type="hidden" name="author_name" value="Matic">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
            ...
            <div style="display: none;" class="card mt-4 pb-1 sm:mt-5 lg:mt-6">
              ...
              <div class="scrollbar-sm flex space-x-4 overflow-x-auto overflow-y-hidden px-4 pb-2 sm:px-5">
                <div class="flex w-72 shrink-0 flex-col">
                  <div class="flex items-center space-x-2">
                    <img class="h-6 w-6" src="../images/logos/bitcoin.svg" alt="flag">
                    <div>
                      <span>Bitcoin</span>
                ...
                <div class="flex w-72 shrink-0 flex-col">
                  <div class="flex items-center space-x-2">
                    <img class="h-6 w-6" src="../images/logos/ethereum.svg" alt="flag">
                    <div>
                      <span>Ethereum</span>
                      <span class="text-xs uppercase text-slate-400 dark:text-navy-300">
                        ETH
                ...
                <div class="flex w-72 shrink-0 flex-col">
                  <div class="flex items-center space-x-2">
                    <img class="h-6 w-6" src="../images/logos/solana.svg" alt="flag">
                    <div>
                      <span>Solana</span>
                      <span class="text-xs uppercase text-slate-400 dark:text-navy-300">
                        SOl
                ...
                <div class="flex w-72 shrink-0 flex-col">
                  <div class="flex items-center space-x-2">
                    <img class="h-6 w-6" src="../images/logos/litecoin.svg" alt="flag">
                    <div>
                      <span>Litecoin</span>
                      <span class="text-xs uppercase text-slate-400 dark:text-navy-300">
                        LTC
...
<?php
                ...
                $run_sql9 = $connect->query($sql9);
                 ...
                 if ($run_sql9->num_rows == NULL) {
                  ...
                  echo '
                   <div class=" overflow-x-auto" style="justify-content: right;">
              <div >
                  <div class="card mt-3">
                <div >
                  <table class=" overflow-x-auto is-hoverable w-full text-left">
                    <thead>
                      <tr>
