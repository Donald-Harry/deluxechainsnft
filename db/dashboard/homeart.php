...
<html lang="en">
  <head>
    ...
    <title>deluxenfts - Dashboard</title>
                ...
                <div :class="isShowPopper && 'show'" class="popper-root fixed" x-ref="popperRoot">
                  <div class="popper-box w-64 rounded-lg border border-slate-150 bg-white shadow-soft dark:border-navy-600 dark:bg-navy-700">
                    ...
                    <div class="flex flex-col pt-2 pb-5">
                      ...
                      <a href="mailto:info@deluxenfts.online" class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
            ...
            <div class="card bg-gradient-to-br from-purple-500 to-indigo-600 px-4 pb-4 sm:px-5">
              <div class="flex items-center justify-between py-3 text-white">
                ...
                <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="isShowPopper && (isShowPopper = false)" class="inline-flex">
                  <button x-ref="popperRef" @click="isShowPopper = !isShowPopper" class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewbox="0 0 24 24" stroke="currentColor" stroke-width="2">
  ...
  <?php
                  ...
                  if ($run_sql == TRUE) {
                    ...
                    <div class="col-lg-6 m-b-30">
                       <input  style="text-align: center; font-weight: bold; background-color: #9552f3; color: #fff;" type="text" class="form-control" id="myWallet" value="'.$wallet.'" readonly="" style="font-size: 15px">
                ...
                ?>
                    ...
                    <button onclick="myFunction()" class="btn h-5 w-5 shrink-0 rounded-full p-0 text-white hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                  ...
                  <div class="mt-3 text-3xl font-semibold text-white">
                   $ <?php echo $_SESSION['balance']; ?>.00
                  </div>
                  <p class="mt-3 text-xs+ text-indigo-100"> <i class="fa-brands fa-ethereum text-sm+"></i> <?php echo $_SESSION['bonus']; ?> ETH</p>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4 sm:gap-5 lg:gap-6">
                  <div>
                    ...
                    <div class="mt-1 flex items-center space-x-2">
                      ...
                      <p class="text-base font-medium text-white"> $ <?php echo $_SESSION['balance']; ?>.00</p>
                    </div>

                <!-- Include Alpine.js and alpine-popper libraries -->
<script src="https://cdn.jsdelivr.net/npm/alpinejs@2.x/dist/alpine.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/alpine-popper@2.x"></script>
...
<div x-data="{showModal:false}">
      ...
      >
        ...
        >
          ...
          <div class="px-4 py-4 sm:px-5">
             <div class="card bg-gradient-to-br from-purple-500 to-indigo-600 px-4 pb-4 sm:px-5">
                            <div class="flex items-center justify-between py-3 text-white">
                                <h2 class="text-sm+ font-medium tracking-wide">Your Wallet Address</h2>
                                <div x-data="usePopper({placement:'bottom-end',offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" class="inline-flex">
                                    <button x-ref="popperRef" @click="isShowPopper = !isShowPopper" class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h.01M12 12h.01M19 12h.01M6 12a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0zm7 0a1 1 0 11-2 0 1 1 0 012 0z"></path>
                            ...
                            <div class="flex grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-1 sm:gap-5 lg:gap-1">
                                <div>
                ...
                ?>
                                      <!--   <button onclick="copyNftAddress()" x-tooltip.placement.right="'Click to Copy Wallet Address'" class="btn h-5 w-5 shrink-0 rounded-full p-0 text-white hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                                                <path d="M7 9a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2H9a2 2 0 01-2-2V9z"></path>
                                                <path d="M5 3a2 2 0 00-2 2v6a2 2 0 002 2V5h8a2 2 0 00-2-2H5z"></path>
                                            </svg>
                                    ...
                                    <div class="mt-3 text-3xl font-semibold text-white">
                                        $ 0.00                                    </div>
                                    <p class="mt-3 text-xs+ text-indigo-100"><i class="fa-brands fa-ethereum text-sm+"></i> <b>0</b> ETH</p> -->
                                     <button onclick="myFunction()" x-tooltip.placement.right="'Click to Copy Wallet Address'" class="btn h-5 w-5 shrink-0 rounded-full p-0 text-white hover:bg-white/20 focus:bg-white/20 active:bg-white/25">
                      <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewbox="0 0 20 20" fill="currentColor">
                        <path d="M7 9a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2H9a2 2 0 01-2-2V9z"></path>
                        <path d="M5 3a2 2 0 00-2 2v6a2 2 0 002 2V5h8a2 2 0 00-2-2H5z"></path>
                      </svg>
                  ...
                  <p class="mt-3 text-xs+ text-indigo-100"> <i class="fa-brands fa-ethereum text-sm+"></i> <?php echo $_SESSION['bonus']; ?> ETH</p>
                        ...
                        <div class="mt-2 space-y-4">
                                <div x-data="{config:{numeral: true,numeralThousandsGroupStyle: 'thousand'}}">
                                    <span class="text-xs+">Amount Deposited</span>
                                     <?php
    ...
    ?>
                                    <form action="../controller/deposits.php" method="post">                                    
                                      <div class="mt-1.5 flex h-9 -space-x-px">
                                         <input type="hidden" name="fname" class="form-control" id="inputPassword3" value="<?php echo $_SESSION['firstname'] ?>">
                                         <input type="hidden" name="email" class="form-control" id="inputPassword3" value="<?php echo $_SESSION['email'] ?>">

                                        <input type="hidden" name="account_id" class="form-control" id="inputPassword3" value="<?php echo $_SESSION['account_id'] ?>">
                                        <select class="form-select rounded-l-lg border border-slate-300 bg-white px-3 py-2 pr-9 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                                            <option name="currency" required="" class="hover:bg-primary/20" x-tooltip.placement.right="'Dollar'">Dollar ($)</option>
                                        </select>
                                        <input  x-input-mask="config" name="amount" onblur="amountInput()" class="form-input w-full rounded-r-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Amount" required>
                                        
                                    </div>
                                    <button type="submit" class="btn mt-5 h-10 w-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
              ...
              <div class="space-x-2 text-right">
                  ...
                  <div>
                    ...
                    <div class="mt-1 flex items-center space-x-2">
                      ...
                      <p class="text-base font-medium text-white"> $ <?php echo $_SESSION['expenses']; ?>.00</p>
                    </div>
                    <div x-data="{showModal:false}">
    <button
        ...
        >
          ...
          <div class="px-4 py-4 sm:px-5">
            ...
            <div class="mt-4 space-y-4">
                <label class="block">
                   <form action="../controller/process_withdrawal.php" method="post">
                       <input type="hidden" name="fname" value="<?php echo $_SESSION['firstname'] ?>">
                      <input type="hidden" name="email" value="<?php echo $_SESSION['email'] ?>">
                      <input type="hidden" name="user_id" value="<?php echo $_SESSION['id'] ?>">
                       <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id'] ?>">
                                    <span>Paste Your Wallet Adress:</span>
                                    <input name="wallet_address" x-init="$el._tom = new Tom($el,{create:true,plugins: ['caret_position','input_autogrow']})" placeholder="Paste ETH Wallet Address Here" type="text" tabindex="-1"><div class="ts-wrapper mt-1.5 w-full multi plugin-caret_position plugin-input_autogrow required invalid has-options">
              </label>
             <div x-data="{config:{numeral: true,numeralThousandsGroupStyle: 'thousand'}}">
                                    <span class="text-xs+">Amount</span>
                                    <div class="mt-1.5 flex h-9 -space-x-px">
                                        <select class="form-select rounded-l-lg border border-slate-300 bg-white px-3 py-2 pr-9 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:bg-navy-700 dark:hover:border-navy-400 dark:focus:border-accent">
                                            <option name="currency"  class="hover:bg-primary/20" x-tooltip.placement.right="'Dollar'">Dollar ($)</option>
                                        </select>
                                        <input name="amount" onblur="amountInput()" class="form-input w-full rounded-r-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="How Much Are You Withdrawing?">
                                    </div>
                                </div>
              <div class="mt-5 flex justify-between text-slate-400 dark:text-navy-300">
                                <p class="text-xs+">Commission:</p>
 ...
 -->                  </div>
            ...
            <div class="col-span-12 lg:col-span-8 xl:col-span-9">
                <div class="flex items-center justify-between py-5">
                  ...
                  <a href="../marketplace" class="border-b border-dotted border-current pb-0.5 font-medium text-primary outline-none transition-colors duration-300 hover:text-primary/70 focus:text-primary/70 dark:text-accent-light dark:hover:text-accent-light/70 dark:focus:text-accent-light/70">View All</a>
                </div>
                <div class="is-scrollbar-hidden overflow-x-auto">
                  <div class="flex w-max space-x-3">
                    <a href="home.php" class="tag h-7 rounded-full bg-slate-150 text-xs+ text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-700 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                      🔥 All
                    </a>
                    <a href="homeart.php" class="tag h-7 rounded-full bg-slate-150 text-xs+ text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-700 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                      🎨 Art
                    </a>
                    <a href="homegame.php" class="tag h-7 rounded-full bg-slate-150 text-xs+ text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-700 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                      🎯 Game
                    </a>
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                      ...
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1689540466grid-0014.png" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <a href="#" class="mt-1.5 text-base font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                          Body horror ii                        </a>
                        <div class="mt-2 flex items-center justify-between">
                          <p class="text-xs text-slate-400 dark:text-navy-300">
                            Price
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="9.47">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1689540466grid-0014.png">
                                    <input type="hidden" name="author_name" value="MouthMoth">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1689491103FB_IMG_1689490213804.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <a href="#" class="mt-1.5 text-base font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                          great paitain gof a wterfall                        </a>
                        <div class="mt-2 flex items-center justify-between">
                          <p class="text-xs text-slate-400 dark:text-navy-300">
                            Price
                          </p>
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="7.09">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1689491103FB_IMG_1689490213804.jpg">
                                    <input type="hidden" name="author_name" value="jaker">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1687905335inbound2624395988436824831.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="116.04">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1687905335inbound2624395988436824831.jpg">
                                    <input type="hidden" name="author_name" value="Daniel22">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/168702110902.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="636">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/168702110902.jpg">
                                    <input type="hidden" name="author_name" value="BlueStudyArt">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/169074097320230730_200114.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="9.21">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/169074097320230730_200114.jpg">
                                    <input type="hidden" name="author_name" value="bunda.adam">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/16848621835zb.png" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="4.2">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/16848621835zb.png">
                                    <input type="hidden" name="author_name" value="Zakia-Badri">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/food-11.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.92">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/food-11.jpg">
                                    <input type="hidden" name="author_name" value="AvrilMellisa">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1689788601IMG_0160.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="2.34">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1689788601IMG_0160.jpeg">
                                    <input type="hidden" name="author_name" value="Katythebrush">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1687006997pintrest girl.png" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="5.32">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1687006997pintrest girl.png">
                                    <input type="hidden" name="author_name" value="Hina_illustration">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691335267inbound4857178022614481275.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="6.72">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1691335267inbound4857178022614481275.jpg">
                                    <input type="hidden" name="author_name" value="Bizaart">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1689829689inbound2236550627804675769.png" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="3.48">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1689829689inbound2236550627804675769.png">
                                    <input type="hidden" name="author_name" value="Digitaldrawing_by_ajju">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1687625711project2 (1).png" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="9.2">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1687625711project2 (1).png">
                                    <input type="hidden" name="author_name" value="khattushyam">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="9.21">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1687625711project2 (1).png">
                                    <input type="hidden" name="author_name" value="chirag">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1684874188inbound3611742292278944400.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="3.38">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1684874188inbound3611742292278944400.jpg">
                                    <input type="hidden" name="author_name" value="oga.">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1685379432WhatsApp Image 2023-05-16 at 8.33.39 AM-2.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="6.93">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1685379432WhatsApp Image 2023-05-16 at 8.33.39 AM-2.jpeg">
                                    <input type="hidden" name="author_name" value="Artofabba">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1692313420inbound4575652851518650086.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="10.37">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1692313420inbound4575652851518650086.jpg">
                                    <input type="hidden" name="author_name" value="Artfulendeavours">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1685754648NFT-004.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="7.01">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1685754648NFT-004.jpg">
                                    <input type="hidden" name="author_name" value="jacaranda.tattoo">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691335506inbound5148757357857986254.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="6.72">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1691335506inbound5148757357857986254.jpg">
                                    <input type="hidden" name="author_name" value="Bizaart">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
            ...
            <div style="display: none;" class="mt-4 sm:mt-5 lg:mt-6">
              <div class="flex items-center justify-between">
          ...
          <div style="display: none;" class="col-span-12 grid grid-cols-1 gap-4 sm:gap-5 lg:col-span-4 lg:gap-6">
            <div class="card pb-4">
              ...
              <div class="scrollbar-sm flex space-x-3 overflow-x-auto px-4 pb-3 sm:px-5">
                <div class="w-48 shrink-0 rounded-lg bg-gradient-to-br from-amber-400 to-orange-600 p-[3px]">
                  <div class="rounded-lg bg-white p-3 dark:bg-navy-700">
                    <div class="flex items-center justify-between">
                      <p>Bitcoin</p>
                      <img src="../images/logos/bitcoin.svg" class="h-6 w-6" alt="logo">
                    </div>
                ...
                <div class="w-48 shrink-0 rounded-lg bg-gradient-to-br from-purple-500 to-indigo-600 p-[3px]">
                  <div class="rounded-lg bg-white p-3 dark:bg-navy-700">
                    <div class="flex items-center justify-between">
                      <p>Litecoin</p>
                      <img src="../images/logos/litecoin.svg" class="h-6 w-6" alt="logo">
                    </div>
                ...
                <div class="w-48 shrink-0 rounded-lg bg-gradient-to-br from-info to-info-focus p-[3px]">
                  <div class="rounded-lg bg-white p-3 dark:bg-navy-700">
                    <div class="flex items-center justify-between">
                      <p>Ethereum</p>
                      <img src="../images/logos/ethereum.svg" class="h-6 w-6" alt="logo">
                    </div>
              ...
              <div style="display: none;" class="mt-1 px-4 sm:px-5">
                <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                  Send Money
                </h2>
              ...
              <div style="display: none;" class="px-4 sm:px-5">
                <div class="flex items-center justify-between">
                  <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                    Exchange
                  </h2>
                ...
                <div class="relative">
                  ...
                  <div class="absolute right-0 top-1/2 mt-1">
                    <button class="btn mask is-hexagon h-7 w-7 bg-primary p-0 font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
...
<?php
                ...
                $sql9 = "SELECT * FROM `trades` WHERE `client_id` = '".$_SESSION['account_id']."'";

                $run_sql9 = $connect->query($sql9);

                 if ($run_sql9->num_rows == NULL) {
                ...
                <div >
                  <table class="is-hoverable w-full text-left">
                    ...
                    <tbody>';
                      ...
                      $count = 1;
                                    while ($detail = $run_sql9->fetch_assoc()) {
                                            ...
                                            echo' <tr class="border-y border-transparent border-b-slate-200 dark:border-b-navy-500">
