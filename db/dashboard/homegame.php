            ...
            <div class="col-span-12 lg:col-span-8 xl:col-span-9">
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                      ...
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1684798293Default_Meet_X7E_a_towering_behemoth_of_metal_and_circuitry_It_0_80f8d25f-fd88-4aa0-813a-e3d1d0b3094a_1.jpg" alt="image">
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="0.72">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/1684798293Default_Meet_X7E_a_towering_behemoth_of_metal_and_circuitry_It_0_80f8d25f-fd88-4aa0-813a-e3d1d0b3094a_1.jpg">
                                    <input type="hidden" name="author_name" value="vexxshadow">
                                    ...
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/038F464B-58CB-48D7-8D02-60ACEFB670AB.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                         ...
                         <form action="../controller/buynow_process.php" method="post">
                                    <input type="hidden" name="nft_amount" value="18.36">
                                    <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/038F464B-58CB-48D7-8D02-60ACEFB670AB.jpeg">
                                    <input type="hidden" name="author_name" value="RTFKTCLONEXTM">
                                    <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
                                    <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
                                    <button style="width: 100%; margin: 10px;" type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
                                      <i class="fa-solid fa-money text-sm+"></i>
              ...
              <div style="display: none;" class="scrollbar-sm flex space-x-4 overflow-x-auto overflow-y-hidden px-4 pb-2 sm:px-5">
