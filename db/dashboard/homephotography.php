            ...
            <div class="col-span-12 lg:col-span-8 xl:col-span-9">
                ...
                <div class="is-scrollbar-hidden overflow-x-auto">
                  <div class="flex w-max space-x-3">
                    ...
                    <a href="homephotography.php" class="tag h-7 rounded-full bg-slate-150 text-xs+ text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-700 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                      📸 Photograpgy
                    </a>
                  </div>
                </div>
                <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                      ...
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1689427319637AAF97-06A9-4F10-BB7C-E53CEEDBCC1C.jpeg" alt="image">
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1684516852XFXQ7594.jfif" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/169177812620161030_183724....jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691323248FB_IMG_1684327441021.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/FCC043AE-54E4-4577-9150-D29792C77ABA.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691684039IMG-20220329-WA0002.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691445957IMG_20230806_110201-01.JPEG" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691864507IMG_20191122_173953.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691783794IMG_0025.............jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1690279659Kobaltsky Industrial Art Prancing Horse Statue.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                      ...
                      <div class="mx-2 mt-3">
                        ...
                        <a href="#" class="mt-1.5 text-base font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                          Kobaltsky Industrial Art Prancing Horse Statue                        </a>
                        <div class="mt-2 flex items-center justify-between">
                          <p class="text-xs text-slate-400 dark:text-navy-300">
                            Price
                          </p>
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691783670IMG_20170821_120635_HDR....jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/1691830776IMG_4631.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
