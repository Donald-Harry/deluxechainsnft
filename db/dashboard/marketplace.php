        ...
        <div class="col-span-12 lg:col-span-12">
          <div class="col-span-12 lg:col-span-8 xl:col-span-9">
            <div class="flex items-center justify-between py-5">
              ...
              <small class="text-small">Contains list of available tokens curated by other creators and auctioned for
                sale</small>
            </div>
...
';
        ...
        ';
            ...
            <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
              <div class="card p-2 pb-3">
                <div class="relative w-full">
                  <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art.jfif"
                    alt="image">
                  <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
              ...
              <div class="card p-2 pb-3">
                <div class="relative w-full">
                  <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art14.jpg"
                    alt="image">
                  <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
              ...
              <div class="card p-2 pb-3">
                <div class="relative w-full">
                  <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art15.jpg"
                    alt="image">
                  <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
