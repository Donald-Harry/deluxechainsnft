...
<html lang="en">
  <head>
    ...
    <title>deluxenfts - Marketplace</title>
          ...
          <div class="col-span-12 lg:col-span-12">
            <div class="col-span-12 lg:col-span-8 xl:col-span-9">
              <div class="flex items-center justify-between py-5">
                ...
                <small class="text-small">Contains list of available tokens curated by other creators and auctioned for sale</small>
              </div>
              <div class="is-scrollbar-hidden overflow-x-auto">
                <div class="flex w-max space-x-3">
                  <a href="marketplace.php" class="tag h-7 rounded-full bg-slate-150 text-xs+ text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-700 dark:text-navy-100 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    🔥 All
                  </a>
              ...
              <?php
$sql1 = 'SELECT * FROM `tokens` WHERE `user_id` = "' . $_SESSION['id'] . '" AND `status` = "Approved" ORDER BY `id` DESC';
$run_sql1 = $connect->query($sql1);
$row1 = $run_sql1->num_rows;
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">No NFT Approved Yet!</h3>
                            </div>
                            <div class="card-body table-responsive p-0" style="height: 410px;">
';
} else {
    echo '<div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">';
    $count = 1;
    while ($detail1 = $run_sql1->fetch_assoc()) {
        $_SESSION['photo'] = $detail1['photo'];
        $username = $detail1['username'];
        $product_name = $detail1['product_name'];
        $collection_id = $detail1['collection_id'];
        $price = $detail1['price']; 
        $status = $detail1['status'];
        $price_in_usd = $price * 1828.63;
        $usd_price = number_format($price_in_usd);

        echo '
            <div class="card p-2 pb-3">
                <div class="relative w-full">
                    <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts' . $_SESSION['photo'] . '" alt="image">
                ...
                <div class="mx-2 mt-3">
                    ...
                    <a class="mt-1.5 text-base font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                        ' . $product_name . '
                    </a>
                    <p>
                        Author: ' . $username . '
                    ...
                    <div class="mt-2 flex items-center justify-between">
                        ...
                        <div class="flex">
                            <div x-data="{showModal:true}">
                                <a href="home.php" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
...
?>
              ...
              <div class="mt-4 grid grid-cols-1 gap-4 sm:mt-5 sm:grid-cols-3 sm:gap-5 lg:mt-6 lg:gap-6">
                                  <div class="card p-2 pb-3">
                    <div class="relative w-full">
                      <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art.jfif" alt="image">
                      <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                    ...
                    <div class="mx-2 mt-3">
                      ...
                      <a href="#" class="mt-1.5 text-base font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
                        athan                      </a>
                      <p>
                        Author: Zakia-Badri                      </p>
                      <div class="mt-2 flex items-center justify-between">
      <p class="text-xs text-slate-400 dark:text-navy-300"></p>
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="3.72">
            <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art.jfif">
            ...
            <button type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
              <i class="fa-solid fa-money text-sm+"></i>
              <span>Buy Now</span>
            </button>
          </form>
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            ...
            <input type="hidden" name="author_name" value="mahtab">
            <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
            <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
            <button type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
              <i class="fa-solid fa-money text-sm+"></i>
...
<div class="card p-2 pb-3">
  ...
  <div class="mx-2 mt-3">
    <div class="flex justify-between text-center text-xs"></div>
    <a href="#" class="mt-1.5 text-base font-medium text-slate-700 line-clamp-1 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light">
      nature
    </a>
    <p>
    ...
    <div class="mt-2 flex items-center justify-between">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="5.69">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="6.09">
            <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art6.webp">
            <input type="hidden" name="author_name" value="rukhsana">
            <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
            <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
            <button type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
              <i class="fa-solid fa-money text-sm+"></i>
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="15.49">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="12">
            <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art8.avif">
            <input type="hidden" name="author_name" value="Ivan_Minichiello">
            <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
            <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
            <button type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
              <i class="fa-solid fa-money text-sm+"></i>
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="4.02">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="6.03">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="9.32">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="3.42">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="6.01">
      ...
      <p></p>
                        <p>
                          ...
                          <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                  ...
                                  <div class="card p-2 pb-3">
                    <div class="relative w-full">
                      <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art14.jpg" alt="image">
                      <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="9.5">
            <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art14.jpg">
            <input type="hidden" name="author_name" value="mahtab">
            <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
            <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
            <button type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
      ...
      <p></p>
                        <p>
                          ...
                          <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                  ...
                                  <div class="card p-2 pb-3">
                    <div class="relative w-full">
                      <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art15.jpg" alt="image">
                      <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
      ...
      <div class="flex">
        <div x-data="{showModal:false}">
          <form action="../controller/buynow_process.php" method="post">
            <input type="hidden" name="nft_amount" value="16.19">
            <input type="hidden" name="nft_picture" value="../xpanel/uploads/nfts/art15.jpg">
            <input type="hidden" name="author_name" value="mahtab">
            <input type="hidden" name="balance" value="<?php echo $_SESSION['balance']; ?>"> 
            <input type="hidden" name="account_id" value="<?php echo $_SESSION['account_id']; ?>">
            <button type="submit" class="btn space-x-2 rounded-full bg-success font-medium text-white hover:bg-success-focus focus:bg-success-focus active:bg-success-focus/90 dark:bg-success dark:hover:bg-success-focus dark:focus:bg-success-focus dark:active:bg-success/90">
