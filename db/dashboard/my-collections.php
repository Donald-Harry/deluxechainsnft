              ...
              <div :class="isShowPopper && 'show'" class="popper-root fixed" x-ref="popperRoot">
                <div
                  ...
                  <div class="flex flex-col pt-2 pb-5">
                    ...
                    <a href="mailto:info@deluxeartsnft.online"
                      class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
        ...
        <div class="sm:hidden lg:block col-span-12 lg:col-span-4">
          <div class="card p-4 sm:p-5">
            ...
            <ul class="mt-6 space-y-1.5 font-inter font-medium">
              ...
              <a class="flex items-center space-x-2 rounded-lg bg-success px-4 py-2.5 tracking-wide text-white outline-none transition-all dark:bg-success"
                href="#">
                <i class="fa-solid fa-money"></i>
...
';
  ...
  <noscript><a href="https://txt.me/reviews/c83816a4-babc-4969-a6e4-a6584b863281" rel="nofollow">Rate New Widget
      customer support</a>, powered by <a href="https://txt.me" rel="noopener nofollow"
