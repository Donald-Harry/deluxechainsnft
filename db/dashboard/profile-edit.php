<?php
  ...
  function replace_image_ifNotEixt($file){
  if (file_exists($file) AND $file !="../uploads/") {
    return $file;
  }else{
    return "user.jpg";
  }
...
<html lang="en">
  <head>
    ...
    <title>Deluxeartnft - Dashboard</title>
...
<script src="https://cdn.jsdelivr.net/npm/alpinejs@2.x/dist/alpine.min.js"></script>
<script src="https://cdn.jsdelivr.net/npm/alpine-popper@2.x"></script>

  </head>
  <?php
        include('../controller/connection.php');

        $sql = 'SELECT `balance`, `profit`, `bonus` FROM `trades` WHERE `client_id` = "'.$_SESSION['account_id'].'" ORDER BY date DESC';

        $run_sql = $connect->query($sql);

        if ($run_sql == TRUE) {
          $detail = $run_sql->fetch_assoc();
          $_SESSION['balance'] = $detail['balance'];
          $_SESSION['expenses'] = $detail['profit'];
          $_SESSION['bonus'] = $detail['bonus'];

          $_SESSION['balance'] = number_format($_SESSION['balance']);
          $_SESSION['expenses'] = number_format($_SESSION['expenses']);

        }


                    $sql2 = 'SELECT * FROM `members` WHERE `account_id` = "'.$_SESSION['account_id'].'"';
                    $run2 = $connect->query($sql2);
                     $row2 = $run2->num_rows;
                if ($row2 > 0) {
            
                    
                 $feed = $run2->fetch_assoc();
  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
      ...
      <div class="sidebar print:hidden">
        ...
        <div class="main-sidebar">
          <div class="flex h-full w-full flex-col items-center border-r border-slate-150 bg-white dark:border-navy-700 dark:bg-navy-800">
            ...
            <div class="flex pt-4">
              <a href="index.htm">
                <img class="h-11 w-11 transition-transform duration-500 ease-in-out hover:rotate-[360deg]" src="../images/logo.png" alt="logo">
              </a>
            </div>
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
              <!-- Dashobards -->
              <a href="home.php" class="flex h-11 w-11 items-center justify-center rounded-lg bg-primary/10 text-primary outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:bg-navy-600 dark:text-accent-light dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90" x-tooltip.placement.right="'Dashboards'">
              ...
              <!-- Apps -->
              <a style="display: none;" href="apps-list.html" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Applications'">
              ...
              <!-- Pages And Layouts -->
              <a style="display: none;" href="pages-card-user-1.html" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Pages & Layouts'">
                <svg class="h-7 w-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- Forms -->
              <a style="display: none;" href="form-input-text.html" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Forms'">
                <svg class="h-7 w-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <!-- Elements -->
              <a style="display: none;" href="elements-avatar.html" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25" x-tooltip.placement.right="'Elements'"> 
                <svg class="h-7 w-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
              <!-- Settings -->
              <a href="profile-edit.php" class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                <svg class="h-7 w-7" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div :class="isShowPopper && 'show'" class="popper-root fixed" x-ref="popperRoot">
                  <div class="popper-box w-64 rounded-lg border border-slate-150 bg-white shadow-soft dark:border-navy-600 dark:bg-navy-700">
                    ...
                    <div class="flex flex-col pt-2 pb-5">
                      <a href="profile.php" class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                        ...
                        <div>
                          ...
                          <div class="text-xs text-slate-400 line-clamp-1 dark:text-navy-300">
                            <?=$_SESSION['firstname']?>, Account Update
                          </div>
                        </div>
                      </a>
                      <a href="mailto:info@deluxeartsnft.online" class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                      ...
                      <a href="transactions.php" class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                     ...
                     <!--    <div>
                      ...
                      <a href="profile-edit.php" class="group flex items-center space-x-3 py-2 px-4 tracking-wide outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                      ...
                      <div class="mt-3 px-4">
                        <button  class="btn h-9 w-full space-x-2 bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90"> 
                          <a class="btn h-9 w-full space-x-2 bg-primary text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90" href="logout.php">  
        ...
        <li>
          <a x-data="navLink" href="marketplace.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out font-medium text-primary dark:text-accent-light">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
        ...
        <li>
          <a x-data="navLink" href="my-collections.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
        ...
        <li>
          <a x-data="navLink" href="create-token.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
      ...
      <div class="my-3 mx-4 h-px bg-slate-200 dark:bg-navy-500"></div>
        ...
        <li>
          <a x-data="navLink" href="transactions.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
      ...
      <div class="my-3 mx-4 h-px bg-slate-200 dark:bg-navy-500 mt-10"></div>
      <ul class="flex flex-1 flex-col px-4 font-inter mt-20">
        <!-- <li>
        ...
        <li>
          <a x-data="navLink" href="help-center.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
        ...
        <li>
          <a x-data="navLink" href="openseapro.php" :class="isActive ? 'font-medium text-primary dark:text-accent-light' : 'text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50'" class="flex py-2 text-xs+ tracking-wide outline-none transition-colors duration-300 ease-in-out text-slate-600 hover:text-slate-900 dark:text-navy-200 dark:hover:text-navy-50">
            <span>
              <span class="badge bg-slate-150 text-slate-800 space-x-2 dark:bg-navy-500 dark:text-navy-100">
              ...
              <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                ...
                <div class="mt-3 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <img class="rounded-full ring ring-white dark:ring-navy-700" src="<?=replace_image_ifNotEixt('../uploads/'.$feeder)?>" alt="avatar">
                    </div>
                  </div>
                  <button class="btn h-7 w-7 rounded-full bg-slate-150 p-0 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-45" fill="none" viewbox="0 0 24 24" stroke="currentColor">
      ...
      <main class="main-content w-full px-[var(--margin-x)] pb-8">
       ...
       <div class="flex items-center space-x-4 py-5 lg:py-6">
          ...
          <div class="sm:hidden lg:block col-span-12 lg:col-span-4">
                
            <div class="card p-4 sm:p-5">
                
              <div class="flex items-center space-x-4">
                <div class="avatar h-14 w-14">
                  <img class="mask is-squircle" src="<?=replace_image_ifNotEixt('../uploads/'.$feeder)?>" alt="avatar">
                </div>
                <div>
                  <h3 class="text-base font-medium text-slate-700 dark:text-navy-100">
                    <?=$_SESSION['firstname']?> <?=$_SESSION['lastname']?>              </h3>
                  <p class="text-xs+"><b>Username: </b><?=$_SESSION['username']?> </p>
                </div>
              </div>
              <ul class="mt-6 space-y-1.5 font-inter font-medium">
                <li x-data="{showModal:false}">
                  <button @click="showModal = true" class="flex items-center space-x-2 rounded-lg bg-primary px-4 py-2.5 tracking-wide text-white outline-none transition-all dark:bg-accent" href="account-verification.php">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5" x-show="showModal" role="dialog" @keydown.window.escape="showModal = false">
                    ...
                    <div class="relative w-full max-w-lg origin-top rounded-lg bg-white transition-all duration-300 dark:bg-navy-700" x-show="showModal" x-transition:enter="easy-out" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="easy-in" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95">
                        ...
                        <div class="px-4 py-4 sm:px-5">
                            <p>
                               Your account security matters to us. Complete your account verification today to enjoy secure access and full benefits on Deluxeartsnft
                            </p>
                            <form enctype="multipart/form-data" action="../controller/process_verification.php" method="post" >
                                <div class="mt-4 space-y-4">
                                   <label class="block">
                                    ...
                                    <label class="mt-4 block">
                                        <span>Upload National ID Card:</span>
                                    ...
                                    <label class="mt-4 block">
                                        ...
                                        <span class="relative mt-1.5 flex">
                                            <input required="" autofocus="off" name="question" class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Enter Question" type="text">
                                            <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                                    ...
                                    <div class="space-x-2">
                                        <button name="submit" type="submit" class="btn min-w-[7rem] rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                                           Verify Account
                                        </button>
                                    </div>
                                </div>
    ...
    <div class="flex">
        <div x-data="{showModal:false}">
            <button @click="showModal = true" class="btn bg-slate-150 font-medium text-slate-800 hover:bg-slate-200 focus:bg-slate-200 active:bg-slate-200/80 dark:bg-navy-500 dark:text-navy-50 dark:hover:bg-navy-450 dark:focus:bg-navy-450 dark:active:bg-navy-450/90">
                ...
                <span class="text"> Password Update </span>
            </button>
            <template x-teleport="#x-teleport-target">
                <div class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5" x-show="showModal" role="dialog" @keydown.window.escape="showModal = false">
                    <div class="absolute inset-0 bg-slate-900/60 transition-opacity duration-300" @click="showModal = false" x-show="showModal" x-transition:enter="ease-out" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="ease-in" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"></div>
                    <div class="relative w-full max-w-lg origin-top rounded-lg bg-white transition-all duration-300 dark:bg-navy-700" x-show="showModal" x-transition:enter="easy-out" x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="easy-in" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95">
                        ...
                        <div class="px-4 py-4 sm:px-5">
                            <p>
                                Do not share your login information with any third party;
                                Keep your account secured.
                            </p>
                            <form autocomplete="off" action="../controller/process_pwd.php" method="post">
                                <div class="mt-4 space-y-4">
                                    <label class="block">
                                        <span>Username:</span>
                                        <input class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" readonly="" type="text" name="username" value="<?=$_SESSION['username']?> ">
                                    </label>
                                    <label class="mt-4 block">
                                        <span>Current Password:</span>
                                        <span class="relative mt-1.5 flex">
                                            <input required="" autofocus="off" name="current_password" class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Enter Password" type="password">
                                            <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                                                </svg>
                                    ...
                                    <label class="mt-4 block">
                                        ...
                                        <span class="relative mt-1.5 flex">
                                            <input required="" autofocus="off" name="password2" class="form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Enter Password" type="password">
                                            <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                                                </svg>
              ...
              <div class="p-4 sm:p-5">
                <div class="flex flex-col">
                  <span class="text-base font-medium text-slate-600 dark:text-navy-100">Profile Image</span>
                  <div style="margin:auto" class="avatar mt-1.5 h-24 w-24">
                    <div style="margin:auto">
                      <img class="mask is-squircle" src="<?=replace_image_ifNotEixt('../uploads/'.$feeder)?>" alt="<?=$_SESSION['firstname']?>" title="<?=$_SESSION['firstname']?>"> 
                    </div>
                    <div x-data="{showModal:false}" class="absolute bottom-0 right-0 flex items-center justify-center rounded-full bg-white dark:bg-navy-700">
    <button x-tooltip.placement.right="'Click To Update Profile Picture'" @click="showModal = true" class="btn h-6 w-6 rounded-full border border-slate-200 p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:border-navy-500 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
    ...
    <template x-teleport="#x-teleport-target">
        <div class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5" x-show="showModal" role="dialog" @keydown.window.escape="showModal = false">
            ...
            <div class="relative max-w-md rounded-lg bg-white pt-10 pb-4 text-center transition-all duration-300 dark:bg-navy-700" x-show="showModal" x-transition:enter="easy-out" x-transition:enter-start="opacity-0 [transform:translate3d(0,1rem,0)]" x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]" x-transition:leave="easy-in" x-transition:leave-start="opacity-100 [transform:translate3d(0,0,0)]" x-transition:leave-end="opacity-0 [transform:translate3d(0,1rem,0)]">
                <form enctype="multipart/form-data" action="../controller/process_upload.php" method="post">
                    <div class="avatar h-20 w-20">
                        <img class="rounded-full" alt="avatar" src="<?=replace_image_ifNotEixt('../uploads/'.$feeder)?>">
                        <div class="absolute right-0 m-1 h-4 w-4 rounded-full border-2 border-white bg-primary dark:border-navy-700 dark:bg-accent"></div>
                    </div>
                    <div class="mt-4 px-4 sm:px-12">
                        ...
                        <label class="btn relative bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                           <input type="hidden" name="user_id" value="<?=$_SESSION['id']?>">
                            <input type="hidden" name="email" value="<?=$_SESSION['email']?>">
                            <input tabindex="-1" name="photo" type="file" class="pointer-events-none absolute inset-0 h-full w-full opacity-0">
                            <div class="flex items-center space-x-2">
                                <i class="fa-solid fa-cloud-arrow-up text-base"></i>
                                <span>Choose File</span>
                            </div>
                        ...
                        <div class="space-x-3">
                            <button  class="btn min-w-[7rem] rounded-full border border-slate-300 font-medium text-slate-800 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-50 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                                Cancel
                            </button>
                            <button name="submit" type="submit" @click="showModal = false" class="btn min-w-[7rem] rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                                Upload
                            </button>
                        </div>
                    </div>
    ...
    <!-- End of Profile Image Modal -->
                ...
                <form action="../controller/process_profile_details.php" method="post">
                  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <input type="hidden" name="user_id" value="<?=$_SESSION['id']?>">
                    <label class="block">
                      <span>Address </span>
                      <span class="relative mt-1.5 flex">
                        <input name="address" required="" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Update Your Address" type="text" value="<?=$feed['address']?>">
                        <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                          <i class="fa-solid fa-map-marker text-base"></i>
                        </span>
                      </span>
                    </label>
                    <label class="block">
                      ...
                      <span class="relative mt-1.5 flex">
                        <input name="cnumber" required="" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" placeholder="Update Your Phone Number" type="text" value="<?=$feed['cnumber']?>">
                        <span class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                    ...
                    <label class="block">
                      ...
                      <select class="mt-1.5 w-full tomselected " name="country" x-init="$el._tom = new Tom($el,{create: true,sortField: {field: 'text',direction: 'asc'}})" id="tomselect-1" tabindex="-1">
                        
                                                  <option required="" style="font-weight:bold;" value="Afghanistan">Afghanistan</option>
                                                  <option required="" style="font-weight:bold;" value="Albania">Albania</option>
                                                  <option required="" style="font-weight:bold;" value="Algeria">Algeria</option>
                                                  <option required="" style="font-weight:bold;" value="American Samoa">American Samoa</option>
                                                  <option required="" style="font-weight:bold;" value="Andorra">Andorra</option>
                                                  <option required="" style="font-weight:bold;" value="Angola">Angola</option>
                                                  <option required="" style="font-weight:bold;" value="Anguilla">Anguilla</option>
                                                  <option required="" style="font-weight:bold;" value="Antarctica">Antarctica</option>
                                                  <option required="" style="font-weight:bold;" value="Antigua and Barbuda">Antigua and Barbuda</option>
                                                  <option required="" style="font-weight:bold;" value="Argentina">Argentina</option>
                                                  <option required="" style="font-weight:bold;" value="Armenia">Armenia</option>
                                                  <option required="" style="font-weight:bold;" value="Aruba">Aruba</option>
                                                  <option required="" style="font-weight:bold;" value="Australia">Australia</option>
                                                  <option required="" style="font-weight:bold;" value="Austria">Austria</option>
                                                  <option required="" style="font-weight:bold;" value="Azerbaijan">Azerbaijan</option>
                                                  <option required="" style="font-weight:bold;" value="Bahamas">Bahamas</option>
                                                  <option required="" style="font-weight:bold;" value="Bahrain">Bahrain</option>
                                                  <option required="" style="font-weight:bold;" value="Bangladesh">Bangladesh</option>
                                                  <option required="" style="font-weight:bold;" value="Barbados">Barbados</option>
                                                  <option required="" style="font-weight:bold;" value="Belarus">Belarus</option>
                                                  <option required="" style="font-weight:bold;" value="Belgium">Belgium</option>
                                                  <option required="" style="font-weight:bold;" value="Belize">Belize</option>
                                                  <option required="" style="font-weight:bold;" value="Benin">Benin</option>
                                                  <option required="" style="font-weight:bold;" value="Bermuda">Bermuda</option>
                                                  <option required="" style="font-weight:bold;" value="Bhutan">Bhutan</option>
                                                  <option required="" style="font-weight:bold;" value="Bolivia">Bolivia</option>
                                                  <option required="" style="font-weight:bold;" value="Bosnia and Herzegovina">Bosnia and Herzegovina</option>
                                                  <option required="" style="font-weight:bold;" value="Botswana">Botswana</option>
                                                  <option required="" style="font-weight:bold;" value="Bouvet Island">Bouvet Island</option>
                                                  <option required="" style="font-weight:bold;" value="Brazil">Brazil</option>
                                                  <option required="" style="font-weight:bold;" value="British Indian Ocean Territory">British Indian Ocean Territory</option>
                                                  <option required="" style="font-weight:bold;" value="Brunei Darussalam">Brunei Darussalam</option>
                                                  <option required="" style="font-weight:bold;" value="Bulgaria">Bulgaria</option>
                                                  <option required="" style="font-weight:bold;" value="Burkina Faso">Burkina Faso</option>
                                                  <option required="" style="font-weight:bold;" value="Burundi">Burundi</option>
                                                  <option required="" style="font-weight:bold;" value="Cambodia">Cambodia</option>
                                                  <option required="" style="font-weight:bold;" value="Cameroon">Cameroon</option>
                                                  <option required="" style="font-weight:bold;" value="Canada">Canada</option>
                                                  <option required="" style="font-weight:bold;" value="Cape Verde">Cape Verde</option>
                                                  <option required="" style="font-weight:bold;" value="Cayman Islands">Cayman Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Central African Republic">Central African Republic</option>
                                                  <option required="" style="font-weight:bold;" value="Chad">Chad</option>
                                                  <option required="" style="font-weight:bold;" value="Chile">Chile</option>
                                                  <option required="" style="font-weight:bold;" value="China">China</option>
                                                  <option required="" style="font-weight:bold;" value="Christmas Island">Christmas Island</option>
                                                  <option required="" style="font-weight:bold;" value="Cocos (Keeling) Islands">Cocos (Keeling) Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Colombia">Colombia</option>
                                                  <option required="" style="font-weight:bold;" value="Comoros">Comoros</option>
                                                  <option required="" style="font-weight:bold;" value="Democratic Republic of the Congo">Democratic Republic of the Congo</option>
                                                  <option required="" style="font-weight:bold;" value="Republic of Congo">Republic of Congo</option>
                                                  <option required="" style="font-weight:bold;" value="Cook Islands">Cook Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Costa Rica">Costa Rica</option>
                                                  <option required="" style="font-weight:bold;" value="Croatia (Hrvatska)">Croatia (Hrvatska)</option>
                                                  <option required="" style="font-weight:bold;" value="Cuba">Cuba</option>
                                                  <option required="" style="font-weight:bold;" value="Cyprus">Cyprus</option>
                                                  <option required="" style="font-weight:bold;" value="Czech Republic">Czech Republic</option>
                                                  <option required="" style="font-weight:bold;" value="Denmark">Denmark</option>
                                                  <option required="" style="font-weight:bold;" value="Djibouti">Djibouti</option>
                                                  <option required="" style="font-weight:bold;" value="Dominica">Dominica</option>
                                                  <option required="" style="font-weight:bold;" value="Dominican Republic">Dominican Republic</option>
                                                  <option required="" style="font-weight:bold;" value="East Timor">East Timor</option>
                                                  <option required="" style="font-weight:bold;" value="Ecuador">Ecuador</option>
                                                  <option required="" style="font-weight:bold;" value="Egypt">Egypt</option>
                                                  <option required="" style="font-weight:bold;" value="El Salvador">El Salvador</option>
                                                  <option required="" style="font-weight:bold;" value="Equatorial Guinea">Equatorial Guinea</option>
                                                  <option required="" style="font-weight:bold;" value="Eritrea">Eritrea</option>
                                                  <option required="" style="font-weight:bold;" value="Estonia">Estonia</option>
                                                  <option required="" style="font-weight:bold;" value="Ethiopia">Ethiopia</option>
                                                  <option required="" style="font-weight:bold;" value="Falkland Islands (Malvinas)">Falkland Islands (Malvinas)</option>
                                                  <option required="" style="font-weight:bold;" value="Faroe Islands">Faroe Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Fiji">Fiji</option>
                                                  <option required="" style="font-weight:bold;" value="Finland">Finland</option>
                                                  <option required="" style="font-weight:bold;" value="France">France</option>
                                                  <option required="" style="font-weight:bold;" value="France, Metropolitan">France, Metropolitan</option>
                                                  <option required="" style="font-weight:bold;" value="French Guiana">French Guiana</option>
                                                  <option required="" style="font-weight:bold;" value="French Polynesia">French Polynesia</option>
                                                  <option required="" style="font-weight:bold;" value="French Southern Territories">French Southern Territories</option>
                                                  <option required="" style="font-weight:bold;" value="Gabon">Gabon</option>
                                                  <option required="" style="font-weight:bold;" value="Gambia">Gambia</option>
                                                  <option required="" style="font-weight:bold;" value="Georgia">Georgia</option>
                                                  <option required="" style="font-weight:bold;" value="Germany">Germany</option>
                                                  <option required="" style="font-weight:bold;" value="Ghana">Ghana</option>
                                                  <option required="" style="font-weight:bold;" value="Gibraltar">Gibraltar</option>
                                                  <option required="" style="font-weight:bold;" value="Guernsey">Guernsey</option>
                                                  <option required="" style="font-weight:bold;" value="Greece">Greece</option>
                                                  <option required="" style="font-weight:bold;" value="Greenland">Greenland</option>
                                                  <option required="" style="font-weight:bold;" value="Grenada">Grenada</option>
                                                  <option required="" style="font-weight:bold;" value="Guadeloupe">Guadeloupe</option>
                                                  <option required="" style="font-weight:bold;" value="Guam">Guam</option>
                                                  <option required="" style="font-weight:bold;" value="Guatemala">Guatemala</option>
                                                  <option required="" style="font-weight:bold;" value="Guinea">Guinea</option>
                                                  <option required="" style="font-weight:bold;" value="Guinea-Bissau">Guinea-Bissau</option>
                                                  <option required="" style="font-weight:bold;" value="Guyana">Guyana</option>
                                                  <option required="" style="font-weight:bold;" value="Haiti">Haiti</option>
                                                  <option required="" style="font-weight:bold;" value="Heard and Mc Donald Islands">Heard and Mc Donald Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Honduras">Honduras</option>
                                                  <option required="" style="font-weight:bold;" value="Hong Kong">Hong Kong</option>
                                                  <option required="" style="font-weight:bold;" value="Hungary">Hungary</option>
                                                  <option required="" style="font-weight:bold;" value="Iceland">Iceland</option>
                                                  <option required="" style="font-weight:bold;" value="India">India</option>
                                                  <option required="" style="font-weight:bold;" value="Isle of Man">Isle of Man</option>
                                                  <option required="" style="font-weight:bold;" value="Indonesia">Indonesia</option>
                                                  <option required="" style="font-weight:bold;" value="Iran (Islamic Republic of)">Iran (Islamic Republic of)</option>
                                                  <option required="" style="font-weight:bold;" value="Iraq">Iraq</option>
                                                  <option required="" style="font-weight:bold;" value="Ireland">Ireland</option>
                                                  <option required="" style="font-weight:bold;" value="Israel">Israel</option>
                                                  <option required="" style="font-weight:bold;" value="Italy">Italy</option>
                                                  <option required="" style="font-weight:bold;" value="Ivory Coast">Ivory Coast</option>
                                                  <option required="" style="font-weight:bold;" value="Jersey">Jersey</option>
                                                  <option required="" style="font-weight:bold;" value="Jamaica">Jamaica</option>
                                                  <option required="" style="font-weight:bold;" value="Japan">Japan</option>
                                                  <option required="" style="font-weight:bold;" value="Jordan">Jordan</option>
                                                  <option required="" style="font-weight:bold;" value="Kazakhstan">Kazakhstan</option>
                                                  <option required="" style="font-weight:bold;" value="Kenya">Kenya</option>
                                                  <option required="" style="font-weight:bold;" value="Kiribati">Kiribati</option>
                                                  <option required="" style="font-weight:bold;" value="Korea, Democratic People's Republic of">Korea, Democratic People's Republic of</option>
                                                  <option required="" style="font-weight:bold;" value="Korea, Republic of">Korea, Republic of</option>
                                                  <option required="" style="font-weight:bold;" value="Kosovo">Kosovo</option>
                                                  <option required="" style="font-weight:bold;" value="Kuwait">Kuwait</option>
                                                  <option required="" style="font-weight:bold;" value="Kyrgyzstan">Kyrgyzstan</option>
                                                  <option required="" style="font-weight:bold;" value="Lao People's Democratic Republic">Lao People's Democratic Republic</option>
                                                  <option required="" style="font-weight:bold;" value="Latvia">Latvia</option>
                                                  <option required="" style="font-weight:bold;" value="Lebanon">Lebanon</option>
                                                  <option required="" style="font-weight:bold;" value="Lesotho">Lesotho</option>
                                                  <option required="" style="font-weight:bold;" value="Liberia">Liberia</option>
                                                  <option required="" style="font-weight:bold;" value="Libyan Arab Jamahiriya">Libyan Arab Jamahiriya</option>
                                                  <option required="" style="font-weight:bold;" value="Liechtenstein">Liechtenstein</option>
                                                  <option required="" style="font-weight:bold;" value="Lithuania">Lithuania</option>
                                                  <option required="" style="font-weight:bold;" value="Luxembourg">Luxembourg</option>
                                                  <option required="" style="font-weight:bold;" value="Macau">Macau</option>
                                                  <option required="" style="font-weight:bold;" value="North Macedonia">North Macedonia</option>
                                                  <option required="" style="font-weight:bold;" value="Madagascar">Madagascar</option>
                                                  <option required="" style="font-weight:bold;" value="Malawi">Malawi</option>
                                                  <option required="" style="font-weight:bold;" value="Malaysia">Malaysia</option>
                                                  <option required="" style="font-weight:bold;" value="Maldives">Maldives</option>
                                                  <option required="" style="font-weight:bold;" value="Mali">Mali</option>
                                                  <option required="" style="font-weight:bold;" value="Malta">Malta</option>
                                                  <option required="" style="font-weight:bold;" value="Marshall Islands">Marshall Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Martinique">Martinique</option>
                                                  <option required="" style="font-weight:bold;" value="Mauritania">Mauritania</option>
                                                  <option required="" style="font-weight:bold;" value="Mauritius">Mauritius</option>
                                                  <option required="" style="font-weight:bold;" value="Mayotte">Mayotte</option>
                                                  <option required="" style="font-weight:bold;" value="Mexico">Mexico</option>
                                                  <option required="" style="font-weight:bold;" value="Micronesia, Federated States of">Micronesia, Federated States of</option>
                                                  <option required="" style="font-weight:bold;" value="Moldova, Republic of">Moldova, Republic of</option>
                                                  <option required="" style="font-weight:bold;" value="Monaco">Monaco</option>
                                                  <option required="" style="font-weight:bold;" value="Mongolia">Mongolia</option>
                                                  <option required="" style="font-weight:bold;" value="Montenegro">Montenegro</option>
                                                  <option required="" style="font-weight:bold;" value="Montserrat">Montserrat</option>
                                                  <option required="" style="font-weight:bold;" value="Morocco">Morocco</option>
                                                  <option required="" style="font-weight:bold;" value="Mozambique">Mozambique</option>
                                                  <option required="" style="font-weight:bold;" value="Myanmar">Myanmar</option>
                                                  <option required="" style="font-weight:bold;" value="Namibia">Namibia</option>
                                                  <option required="" style="font-weight:bold;" value="Nauru">Nauru</option>
                                                  <option required="" style="font-weight:bold;" value="Nepal">Nepal</option>
                                                  <option required="" style="font-weight:bold;" value="Netherlands">Netherlands</option>
                                                  <option required="" style="font-weight:bold;" value="Netherlands Antilles">Netherlands Antilles</option>
                                                  <option required="" style="font-weight:bold;" value="New Caledonia">New Caledonia</option>
                                                  <option required="" style="font-weight:bold;" value="New Zealand">New Zealand</option>
                                                  <option required="" style="font-weight:bold;" value="Nicaragua">Nicaragua</option>
                                                  <option required="" style="font-weight:bold;" value="Niger">Niger</option>
                                                  <option required="" style="font-weight:bold;" value="Nigeria">Nigeria</option>
                                                  <option required="" style="font-weight:bold;" value="Niue">Niue</option>
                                                  <option required="" style="font-weight:bold;" value="Norfolk Island">Norfolk Island</option>
                                                  <option required="" style="font-weight:bold;" value="Northern Mariana Islands">Northern Mariana Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Norway">Norway</option>
                                                  <option required="" style="font-weight:bold;" value="Oman">Oman</option>
                                                  <option required="" style="font-weight:bold;" value="Pakistan">Pakistan</option>
                                                  <option required="" style="font-weight:bold;" value="Palau">Palau</option>
                                                  <option required="" style="font-weight:bold;" value="Palestine">Palestine</option>
                                                  <option required="" style="font-weight:bold;" value="Panama">Panama</option>
                                                  <option required="" style="font-weight:bold;" value="Papua New Guinea">Papua New Guinea</option>
                                                  <option required="" style="font-weight:bold;" value="Paraguay">Paraguay</option>
                                                  <option required="" style="font-weight:bold;" value="Peru">Peru</option>
                                                  <option required="" style="font-weight:bold;" value="Philippines">Philippines</option>
                                                  <option required="" style="font-weight:bold;" value="Pitcairn">Pitcairn</option>
                                                  <option required="" style="font-weight:bold;" value="Poland">Poland</option>
                                                  <option required="" style="font-weight:bold;" value="Portugal">Portugal</option>
                                                  <option required="" style="font-weight:bold;" value="Puerto Rico">Puerto Rico</option>
                                                  <option required="" style="font-weight:bold;" value="Qatar">Qatar</option>
                                                  <option required="" style="font-weight:bold;" value="Reunion">Reunion</option>
                                                  <option required="" style="font-weight:bold;" value="Romania">Romania</option>
                                                  <option required="" style="font-weight:bold;" value="Russian Federation">Russian Federation</option>
                                                  <option required="" style="font-weight:bold;" value="Rwanda">Rwanda</option>
                                                  <option required="" style="font-weight:bold;" value="Saint Kitts and Nevis">Saint Kitts and Nevis</option>
                                                  <option required="" style="font-weight:bold;" value="Saint Lucia">Saint Lucia</option>
                                                  <option required="" style="font-weight:bold;" value="Saint Vincent and the Grenadines">Saint Vincent and the Grenadines</option>
                                                  <option required="" style="font-weight:bold;" value="Samoa">Samoa</option>
                                                  <option required="" style="font-weight:bold;" value="San Marino">San Marino</option>
                                                  <option required="" style="font-weight:bold;" value="Sao Tome and Principe">Sao Tome and Principe</option>
                                                  <option required="" style="font-weight:bold;" value="Saudi Arabia">Saudi Arabia</option>
                                                  <option required="" style="font-weight:bold;" value="Senegal">Senegal</option>
                                                  <option required="" style="font-weight:bold;" value="Serbia">Serbia</option>
                                                  <option required="" style="font-weight:bold;" value="Seychelles">Seychelles</option>
                                                  <option required="" style="font-weight:bold;" value="Sierra Leone">Sierra Leone</option>
                                                  <option required="" style="font-weight:bold;" value="Singapore">Singapore</option>
                                                  <option required="" style="font-weight:bold;" value="Slovakia">Slovakia</option>
                                                  <option required="" style="font-weight:bold;" value="Slovenia">Slovenia</option>
                                                  <option required="" style="font-weight:bold;" value="Solomon Islands">Solomon Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Somalia">Somalia</option>
                                                  <option required="" style="font-weight:bold;" value="South Africa">South Africa</option>
                                                  <option required="" style="font-weight:bold;" value="South Georgia South Sandwich Islands">South Georgia South Sandwich Islands</option>
                                                  <option required="" style="font-weight:bold;" value="South Sudan">South Sudan</option>
                                                  <option required="" style="font-weight:bold;" value="Spain">Spain</option>
                                                  <option required="" style="font-weight:bold;" value="Sri Lanka">Sri Lanka</option>
                                                  <option required="" style="font-weight:bold;" value="St. Helena">St. Helena</option>
                                                  <option required="" style="font-weight:bold;" value="St. Pierre and Miquelon">St. Pierre and Miquelon</option>
                                                  <option required="" style="font-weight:bold;" value="Sudan">Sudan</option>
                                                  <option required="" style="font-weight:bold;" value="Suriname">Suriname</option>
                                                  <option required="" style="font-weight:bold;" value="Svalbard and Jan Mayen Islands">Svalbard and Jan Mayen Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Swaziland">Swaziland</option>
                                                  <option required="" style="font-weight:bold;" value="Sweden">Sweden</option>
                                                  <option required="" style="font-weight:bold;" value="Switzerland">Switzerland</option>
                                                  <option required="" style="font-weight:bold;" value="Syrian Arab Republic">Syrian Arab Republic</option>
                                                  <option required="" style="font-weight:bold;" value="Taiwan">Taiwan</option>
                                                  <option required="" style="font-weight:bold;" value="Tajikistan">Tajikistan</option>
                                                  <option required="" style="font-weight:bold;" value="Tanzania, United Republic of">Tanzania, United Republic of</option>
                                                  <option required="" style="font-weight:bold;" value="Thailand">Thailand</option>
                                                  <option required="" style="font-weight:bold;" value="Togo">Togo</option>
                                                  <option required="" style="font-weight:bold;" value="Tokelau">Tokelau</option>
                                                  <option required="" style="font-weight:bold;" value="Tonga">Tonga</option>
                                                  <option required="" style="font-weight:bold;" value="Trinidad and Tobago">Trinidad and Tobago</option>
                                                  <option required="" style="font-weight:bold;" value="Tunisia">Tunisia</option>
                                                  <option required="" style="font-weight:bold;" value="Turkey">Turkey</option>
                                                  <option required="" style="font-weight:bold;" value="Turkmenistan">Turkmenistan</option>
                                                  <option required="" style="font-weight:bold;" value="Turks and Caicos Islands">Turks and Caicos Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Tuvalu">Tuvalu</option>
                                                  <option required="" style="font-weight:bold;" value="Uganda">Uganda</option>
                                                  <option required="" style="font-weight:bold;" value="Ukraine">Ukraine</option>
                                                  <option required="" style="font-weight:bold;" value="United Arab Emirates">United Arab Emirates</option>
                                                  <option required="" style="font-weight:bold;" value="United Kingdom">United Kingdom</option>
                                                  <option required="" style="font-weight:bold;" value="United States">United States</option>
                                                  <option required="" style="font-weight:bold;" value="United States minor outlying islands">United States minor outlying islands</option>
                                                  <option required="" style="font-weight:bold;" value="Uruguay">Uruguay</option>
                                                  <option required="" style="font-weight:bold;" value="Uzbekistan">Uzbekistan</option>
                                                  <option required="" style="font-weight:bold;" value="Vanuatu">Vanuatu</option>
                                                  <option required="" style="font-weight:bold;" value="Vatican City State">Vatican City State</option>
                                                  <option required="" style="font-weight:bold;" value="Venezuela">Venezuela</option>
                                                  <option required="" style="font-weight:bold;" value="Vietnam">Vietnam</option>
                                                  <option required="" style="font-weight:bold;" value="Virgin Islands (British)">Virgin Islands (British)</option>
                                                  <option required="" style="font-weight:bold;" value="Virgin Islands (U.S.)">Virgin Islands (U.S.)</option>
                                                  <option required="" style="font-weight:bold;" value="Wallis and Futuna Islands">Wallis and Futuna Islands</option>
                                                  <option required="" style="font-weight:bold;" value="Western Sahara">Western Sahara</option>
                                                  <option required="" style="font-weight:bold;" value="Yemen">Yemen</option>
                                                  <option required="" style="font-weight:bold;" value="Zambia">Zambia</option>
                                                  <option required="" style="font-weight:bold;" value="Zimbabwe">Zimbabwe</option>
                                              </select>
                    </label>
                  </div>
                  <input type="hidden" name="email" value="<?=$_SESSION['email']?>">
                  <div class="my-7 h-px bg-slate-200 dark:bg-navy-500"></div>
                  <div class="flex justify-center space-x-2">
                    <a href="profile-edit.php" class="btn min-w-[7rem] rounded-full border border-slate-300 font-medium text-slate-700 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
                      Cancel
                    </a>
                    <button name="submit" type="submit" class="btn min-w-[7rem] rounded-full bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                      Save Settings
