  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak="">
      ...
      <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <h2 class="mt-3 text-xl font-medium text-slate-800 dark:text-navy-50 lg:text-2xl">
               <?=$_SESSION['firstname']?>'s Transaction History
            </h2>

            <div class="card group col-span-12 pb-5 lg:col-span-10">
                  <div class="my-3 flex flex-col justify-between px-4 sm:flex-row sm:items-center sm:px-5">
                     <div class="flex flex-1 items-center justify-between space-x-2 sm:flex-initial">
                        <h2 class="text-sm+ font-medium tracking-wide text-slate-700 dark:text-navy-100">
                           Token Purchases, Sales and Trans-Activites - <span class="font-small">(Last 15 Transactions)</span>
                        </h2>
                        <div x-data="usePopper({placement:'bottom-start',offset:4})" @click.outside="isShowPopper &amp;&amp; (isShowPopper = false)" :class="!isShowPopper &amp;&amp; 'sm:opacity-0'" class="inline-flex focus-within:opacity-100 group-hover:opacity-100 sm:opacity-0">
                           ...
                           <div x-ref="popperRoot" class="popper-root" :class="isShowPopper &amp;&amp; 'show'" style="position: fixed; inset: 0px 0px auto auto; margin: 0px; transform: translate(-44px, 174px);" data-popper-placement="bottom-end">
                              <div class="popper-box rounded-md border border-slate-150 bg-white py-1.5 font-inter dark:border-navy-500 dark:bg-navy-700">
                                 <ul>
                                    <li>
                                       <a href="home.php" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Dashboard</a>
                                    </li>
                                    <li>
                                       <a href="marketplace.php" class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Marketplace</a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                        ...
                        if ($row == 0) {
                          echo '<p>No Transaction Yet!</p>';
                        } else {
                          while ($detail = $run_sql->fetch_assoc()) {
                            $date = $detail['date'];
                            $amount = $detail['amount'];
                            $price_in_eth = $amount / 1828;
                            $amount_usd = number_format($amount);

                            echo '<div class="grid grid-cols-12 gap-4 px-4 sm:gap-5 sm:px-5 lg:gap-6 lg:px-5">
                                          ...
                                          <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                              <p class="text-slate-700 line-clamp-1 dark:text-navy-100">
                                                <b>Narration: - Withdrawal Request</b>
                                              </p>
                                            </div>
                                          </div>
...
<div class="flex flex-col justify-between sm:flex-row">
    ...
    <p class="font-medium text-error">$ ' . $amount_usd . '</p>
    <p class="font-medium text-error">(' . $price_in_eth . 'ETH)</p>
</div>
