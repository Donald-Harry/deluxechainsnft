...
<script src="https://cdn.jsdelivr.net/npm/alpine-popper@2.x"></script>
  ...
  <body x-data="" class="is-header-blur" x-bind="$store.global.documentBody">
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak=""> 
        ...
        <div class="header-container relative flex w-full bg-white dark:bg-navy-750 print:hidden">
          ...
          <div class="flex w-full items-center justify-between">
            ...
            <div class="-mr-1.5 flex items-center space-x-2">
              ...
              <button style="display: none;" @click="$store.global.isSearchbarActive = !$store.global.isSearchbarActive" class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:hidden">
              ...
              <!-- Dark Mode Toggle -->
              <button style="display: none;" @click="$store.global.isDarkModeEnabled = !$store.global.isDarkModeEnabled" class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
              ...
              <div x-effect="if($store.global.isSearchbarActive) isShowPopper = false" x-data="usePopper({placement:'bottom-end',offset:12})" @click.outside="isShowPopper && (isShowPopper = false)" class="flex">
                ...
                <div style="display: none;" :class="isShowPopper && 'show'" class="popper-root" x-ref="popperRoot">
                  <div x-data="{activeTab:'tabAll'}" class="popper-box mx-4 mt-1 flex max-h-[calc(100vh-6rem)] w-[calc(100vw-2rem)] flex-col rounded-lg border border-slate-150 bg-white shadow-soft dark:border-navy-800 dark:bg-navy-700 dark:shadow-soft-dark sm:m-0 sm:w-80">
                    ...
                    <div style="display: none;" class="tab-content flex flex-col overflow-hidden">
      ...
      <!-- Mobile Searchbar -->
      <div style="display: none;" x-show="$store.breakpoints.isXs && $store.global.isSearchbarActive" x-transition:enter="easy-out transition-all" x-transition:enter-start="opacity-0 scale-105" x-transition:enter-end="opacity-100 scale-100" x-transition:leave="easy-in transition-all" x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95" class="fixed inset-0 z-[100] flex flex-col bg-white dark:bg-navy-700 sm:hidden">
      ...
      <div  x-show="$store.global.isRightSidebarExpanded" @keydown.window.escape="$store.global.isRightSidebarExpanded = false">
        ...
        <div style="display: none;" class="fixed right-0 top-0 z-[151] h-full w-full sm:w-80">
          <div x-data="{activeTab:'tabHome'}" class="relative flex h-full w-full transform-gpu flex-col bg-white transition-transform duration-200 dark:bg-navy-750" x-show="$store.global.isRightSidebarExpanded" x-transition:enter="ease-out" x-transition:enter-start="translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="ease-in" x-transition:leave-start="translate-x-0" x-transition:leave-end="translate-x-full">
            <div style="display: none;" class="flex items-center justify-between py-2 px-4">
            ...
            <div style="display: none;" x-show="activeTab === 'tabHome'" x-transition:enter="transition-all duration-500 easy-in-out" x-transition:enter-start="opacity-0 [transform:translate3d(0,1rem,0)]" x-transition:enter-end="opacity-100 [transform:translate3d(0,0,0)]" class="is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1">
              <label style="display: none;" class="relative flex px-3">
          ...
          <?php
                ...
                $sql = 'SELECT * FROM `withrawals` WHERE `user_id` = "' . $_SESSION['id'] . '"';
      ...
      <main class="main-content w-full px-[var(--margin-x)] pb-8">
       <div class="flex items-center justify-between py-5 lg:py-6">
                    ...
                    <a href="withdrawal.php" class="btn mt-5 h-10 bg-primary font-medium text-white hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                    ...
                    <div class="flex">
                        ...
                        <a href="withdrawal.php" class="btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25 sm:h-9 sm:w-9">
                            <i class="fa-solid fa-home"></i>
                        </a>
                    </div>
                </div>
                        ...
                        <div>
                            <div class="text-right sm:text-right">
                                <div class="space-y-1 pt-2 text-left">
                                    <p><img style="width:100px" src="../images/logo.png" alt=""></p>
                                    <p>Deluxeartnft</p>
                                    <p>United States</p>
                                </div>
                            </div>
                            <div class="text-right">
                                <h1 class="text-lg font-medium text-slate-600 dark:text-navy-100">
                                    Funds Withdrawal
                                </h1>
                                <div class="space-y-1 text-right">
                                    <p>Transaction Receipt (Successful)</p>
                                </div>
                            </div>
                            <div style="border:1px solid" class="my-1 h-px bg-slate-500 dark:bg-navy-500"></div>
                            <div class="mt-4 sm:mt-0 sm:text-right">
                                <p style="text-align:left;" class="text-lg font-medium text-slate-600 dark:text-navy-100">
                                    -
                                </p>
                                <div class="space-y-1 text-right">
                                    <p class="font-semibold"><?=$_SESSION['firstname']?> <?=$_SESSION['lastname']?></p>
                                    <p><?=$detail['email']?></p>
                                    <p></p>
                                </div>
                            </div>
                            <div style="border:1px solid" class="my-1 h-px bg-slate-500 dark:bg-navy-700"></div>
                            <div class="mt-4 sm:mt-0 sm:text-right">
                                <p style="text-align:left;" class="text-lg font-medium text-slate-600 dark:text-navy-100">
                                    Address
                                </p>
                                <div class="space-y-1 text-right">
                                    <p class="font-semibold"><?=$detail['wallet_address']?></p>
                                    <p>ETH Withdrawal</p>
                                </div>
                                <div style="border:1px solid" class="my-1 h-px bg-slate-500 dark:bg-navy-700"></div>
                                <div class="mt-4 sm:mt-0 sm:text-right">
                                    ...
                                    <div class="space-y-1 text-right">
                                        <p class="font-semibold">$ <?=$detail['amount']?>.00</p>
                            ...
                            <div class="my-1 h-px bg-slate-200 dark:bg-navy-500"></div>
                            <div class="flex flex-col justify-between sm:flex-row">
                                <div class="text-left mt-4">
                                    <div class="qr-code center sm:text-center">
                                        <img style="margin:auto; width:120px" src="https://chart.googleapis.com/chart?chs=200x200&amp;cht=qr&amp;chl=http%3A%2F%2Fwww.toprarible.com%2F&amp;choe=UTF-8" >
                                    </div>
                                </div>
                                <div class="mt-2 text-right sm:mt-0">
                                    <div class="space-y-1 pt-2 text-right">
                                        <p style="text-align:justify" class="p-4">
                                            This is an electronic receipt of a transaction and does not require any signature.
                                            The authenticity of transaction can be confirmed with us.
                                            For any other assistance, kindly call True Serve on <a href="Tel:"></a> or
                                            email <a href="mailto:info@deluxeartsnft.online">info@deluxeartsnft.online</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
