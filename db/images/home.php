                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/art11.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/arts20.jpg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
                        ...
                        <div class="mt-2 flex items-center justify-between">
                          ...
                          <p>
                            ...
                            <span class="text-slate-400 dark:text-navy-300">ETH</span>
                                      ...
                                      <div class="card p-2 pb-3">
                      <div class="relative w-full">
                        <img class="h-56 w-full rounded-xl object-cover object-center" src="../xpanel/uploads/nfts/D40424E7-7C5E-42AC-B506-2407EAC6BC02.jpeg" alt="image">
                        <div class="absolute inset-0 flex h-full w-full flex-col justify-between p-3">
                          <div>
                            <div class="badge rounded-full bg-white text-slate-800 dark:bg-navy-600 dark:text-navy-50">
                              <i class="fa-brands fa-ethereum text-sm+"></i>
...
<?php
  ...
  alert("Copied the text: " + copyText.value);
   ...
   <script>
         ...
         <script src="//code.tidio.co/ewwtj10pygyu1jqrhzaynvzb3gipg3oe.js" async></script>
  </body>
</html>
