        ...
        <div class="content">
          ...
          <nav class="navigation">
              ...
              <li class="link linkdrop">
                ...
                <ul class="dropdown" id="dropdown-ul">
                  <li class="dropdown-link">
                    <a href="our-shop.php" class="links"
                      >Our Shop</a
                    >
                  </li>
                  <li class="dropdown-link">
                    <a href="collections.php" class="links"
                      >Collections</a
                    >
                  </li>
                </ul>
            ...
            <ul class="secondary-nav">
              <li class="login">
                <a href="db/enter/register.php" target="_blank" class="login-cta"
                  >Login</a
                >
              </li>
            </ul>
